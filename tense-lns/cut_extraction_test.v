...
Require Import cut.
Require Import cut_extraction_example.
...
(* Problem with Lemma Sixteen extraction without this command. *)
...
Time Separate Extraction cut_example4.
...
(*
Time Separate Extraction cut_extraction_example.
*)

(* 106sec incl the Basic and NatInt libs. *)
