...
Lemma Lemma_Sixteen_SR_wb_bac_ImpR : forall n m
                                            (IH : forall y : nat * nat, y << (S n, m) -> SR_wb y * SR_bb y * SR_p y * SL y)
                                            V G Γ Δ1 Δ2 H Σ1 Σ2 Π I GH A d2
                                            (D1 : pf_LNSKt
                                                    (G ++ [(Γ, Δ1 ++ WBox A :: Δ2, d2)]))
...
Lemma Lemma_Sixteen_SR_wb_bac_ImpL : forall n m
                                            (IH : forall y : nat * nat, y << (S n, m) -> SR_wb y * SR_bb y * SR_p y * SL y)
                                            V G Γ Δ1 Δ2 H Σ1 Σ2 Π I GH A d2
                                            (D1 : pf_LNSKt
                                                    (G ++ [(Γ, Δ1 ++ WBox A :: Δ2, d2)]))
...
Proof.
  ...
  (* ImpR *)
  simpl in *. subst. 
  eapply Lemma_Sixteen_SR_wb_bac_ImpR; eassumption. 

  (* ImpL *) simpl in *. subst.
  eapply Lemma_Sixteen_SR_wb_bac_ImpL; eassumption.
