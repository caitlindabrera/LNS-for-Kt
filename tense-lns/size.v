...
Lemma not_wbox_not_wbox_exp : forall {V : Set} (A : PropF V),
...
Lemma not_wbox_not_wbox_exp_fwd : forall {V : Set} (A : PropF V),
    (not_wbox A) -> (not_wbox_exp A).
Proof. intros V A. apply not_wbox_not_wbox_exp. Qed.

Lemma not_wbox_not_wbox_exp_rev : forall {V : Set} (A : PropF V),
...
Proof.
  intros V A; destruct A;
    try solve [left; eapply not_wbox_not_wbox_exp; econstructor].
