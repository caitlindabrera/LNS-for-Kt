      ...
      Logic.eq_rect_r (Datatypes.app l1 (Datatypes.Coq_cons a l2))
        (let {
          _evar_0_ = let {
                     ...
                     Logic.eq_rect
                       (Datatypes.app l1
                         (Datatypes.app (Datatypes.Coq_cons a l2) c)) _evar_0_
                       (Datatypes.app
...
data Coq_contracted_multi t =
 ...
 | Coq_cont_multi_step (Datatypes.Coq_list t) (Datatypes.Coq_list t) (Datatypes.Coq_list
                                                                     t) 
 (Coq_contracted_gen t) (Coq_contracted_multi t)
             ...
             Logic.eq_rect_r
               ...
               (Logic.eq_rect_r
                 ...
                 (Datatypes.app (Datatypes.Coq_cons a a1)
                   (Datatypes.app b
                     (Datatypes.app (Datatypes.Coq_cons a0 Datatypes.Coq_nil)
                       c))) (Datatypes.Coq_cons a a1) b c) (Datatypes.Coq_cons
                 a
                 (Datatypes.app a1
                   (Datatypes.app b
                     (Datatypes.app (Datatypes.Coq_cons a0 Datatypes.Coq_nil)
             ...
             Logic.eq_rect_r
               ...
               (let {
                ...
                Logic.eq_rect_r
                  ...
                  (Datatypes.app b
                    (Datatypes.app c0 (Datatypes.Coq_cons a
                      Datatypes.Coq_nil))))) y0 c1 hc0 iHHc __) x c __) y1) x0
         __ __ __);
...
contracted_multi_seq :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                        a1) -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list
                        a1) -> LntT.Coq_dir -> (Coq_contracted_multi a1) ->
...
contracted_nseq_refl ns =
  Datatypes.list_rect Coq_cont_nseq_nil (\a ns0 iHns -> Coq_cont_nseq_cons a a
    ns0 ns0 (contracted_seq_refl a) iHns) ns
...
contracted_nseq_single :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                          a1) -> LntT.Coq_dir -> Coq_contracted_nseq a1
                   ...
                   case hin7 of {
                    ...
                    Datatypes.Coq_inr hin8 ->
                     GenT.coq_InT_appR b0 a0
                       ...
                       (GenT.coq_InT_appR b0 (Datatypes.Coq_cons a
                         Datatypes.Coq_nil) (Datatypes.app b c)
                         (GenT.coq_InT_appR b0 b c hin8))}}}}) _UU03a3_ hc0 __)
...
contracted_multi_insertL_pre :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list
                                a1) -> a1 -> (GenT.InT a1) ->
                                (Coq_contracted_multi a1) ->
                                Coq_contracted_multi a1
  ...
  contracted_multi_rect (\x hin0 -> Coq_cont_multi_step
               ...
               (Logic.eq_rect_r
                 ...
                 (Logic.eq_rect_r
                   ...
                   (Datatypes.app Datatypes.Coq_nil
                     (Datatypes.app l2
                       (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil)
                         l4)))) (Datatypes.Coq_cons a l4)) (Datatypes.Coq_cons
               a
               (Datatypes.app Datatypes.Coq_nil
                 (Datatypes.app l2 (Datatypes.Coq_cons a l4)))))
             (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil)
    ...
    contracted_multi_trans
      ...
      (contracted_multi_cons x y a (Coq_cont_multi_step x y y c
        (Coq_cont_multi_refl y))) (iHHc (contracted_gen_InT_rev x y c a hin0)))
    l1 l3 hc hin
...
contracted_multi_appR_InT _UU0393_ _UU03a3_ =
  Datatypes.list_rec (\_UU0393_0 _ -> Coq_cont_multi_refl _UU0393_0)
    ...
    contracted_multi_insertL_pre (Datatypes.app _UU03a3_0 _UU0393_0) _UU0393_0
      a (GenT.coq_InT_appR a _UU03a3_0 _UU0393_0 h2)
...
contracted_seq_multiR :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                         a1) -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list
                         a1) -> LntT.Coq_dir -> LntT.Coq_dir ->
                         (Coq_contracted_seq a1) -> Coq_contracted_multi 
                         a1
                     ...
                     Logic.eq_rec_r d4 (\_ ->
                       Logic.eq_rec_r _UU03a0_0 (\c2 ->
                         Logic.eq_rec_r d4 (\_ -> Coq_cont_multi_refl
                           _UU03a0_0) d3 c2) _UU0394_0 c1) d3) _UU0394_0) y __
                   __) d) _UU0394_1) x __ __ __ h0)}) __ __) s4 c0) s3 c)
    (\s3 s4 c _UU0393_0 _UU0394_0 _UU03a3_0 _UU03a0_0 d3 d4 _ _ ->
    Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0
      _UU0394_0) d3) (\c0 ->
      Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU03a3_0
               ...
               Logic.eq_rec_r d3 (\_ ->
                 Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair
                   ...
                   Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair
                     ...
                     iHcontracted_seq0 h1) s4) d) x) _UU0393_1 __ __ __ h2)})
                 ...
                 Logic.eq_rec_r _UU03a3_0 (\_ ->
                   Logic.eq_rec_r _UU03a0_0 (\_ ->
                     Logic.eq_rec_r d4 (\_ ->
                       Logic.eq_rec_r _UU03a3_0 (\c2 ->
                         Logic.eq_rec_r d4 (\_ -> Coq_cont_multi_refl
                           _UU03a3_0) d3 c2) _UU0393_0 c1) d3) y) _UU0393_0 __
                   __) d) x) _UU0393_1 __ __ __ h0)}) __ __) s4 c0) s3 c)
    (\s3 s4 s5 c h0 iHcontracted_seq _UU0393_0 _UU0394_0 _UU03a3_0 _UU03a0_0 d3 d4 _ _ ->
    Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0
      _UU0394_0) d3) (\c0 ->
      Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU03a3_0
               ...
               Logic.eq_rec_r d3 (\_ ->
                 Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair y
                   ...
                   Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair y
                     ...
                     iHcontracted_seq0 h1) s4) d) _UU0394_1) x __ __ __ h2)})
...
contracted_seq_merge_app2R_rev _UU0393_ _UU0394_ _UU03a3_ _UU03a0_ d h =
  Coq_cont_seq_stepR (Datatypes.Coq_pair (Datatypes.Coq_pair
    ...
    _UU0394_) d) (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_ _UU0394_) d)
    (Coq_cont_seqR (Datatypes.app _UU03a0_ _UU0394_) _UU0394_
