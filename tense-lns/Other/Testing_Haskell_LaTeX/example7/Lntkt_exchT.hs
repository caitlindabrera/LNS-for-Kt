                             ...
                             (case sppc1 of {
                               EW h k1 d1 -> (\_ _ ->
                                Logic.eq_rect (Datatypes.Coq_cons
                                  ...
                                  __)}) __ __) c sppc0) pp0 drs1 acm1) g0 acm0
                         drs0;
...
data LNSKt_rules v =
 ...
 | Coq_prop (Datatypes.Coq_list
            ...
            LntT.Coq_dir))) (Datatypes.Coq_list
                            ...
                            (Gen_tacs.Coq_rel
                            (Datatypes.Coq_list (LntT.PropF v))) LntT.Coq_dir)) 
 (LntT.Coq_nslcrule (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF v)))
       ...
       Logic.eq_rect_r h1 (\_ ->
         Logic.eq_rect_r h2 (\x0 ->
           ...
           LntrsT.gen_swapR_step_pr_lc h1 h2 x0 h4 h5 x1 x2 x3 x4 x5 x6 x7 x8
             x9 x10)) c) ps __ x)}) __ __) ns d g k seq d0 _UU0394_1 _UU0394_2
       ...
       Logic.eq_rect_r h1 (\_ ->
         Logic.eq_rect_r h2 (\x0 ->
           ...
           LntlsT.gen_swapL_step_pr_lc h1 h2 x0 h4 h5 x1 x2 x3 x4 x5 x6 x7 x8
             x9 x10)) c) ps __ x)}) __ __) ns d g k seq d0 _UU0393_1 _UU0393_2
