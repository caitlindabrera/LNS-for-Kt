...
princrule_pfc_LT :: (Datatypes.Coq_list
                    ...
                    (PropF a1)) -> (Coq_princrule_pfc a1) -> Datatypes.Coq_sum
                    () (PropF a1)
    ...
    ImpL_pfc a b -> (\_ _ ->
     Logic.eq_rec (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons
       ...
       Logic.eq_rec (Datatypes.Coq_cons (Imp a b) Datatypes.Coq_nil) (\_ ->
         Logic.eq_rec Datatypes.Coq_nil (Datatypes.Coq_inr (Imp a b)) _UU0394_)
         _UU0393_ __) ps __);
    BotL_pfc -> (\_ _ ->
     Logic.eq_rec Datatypes.Coq_nil (\_ ->
...
princrule_pfc_RT ps _UU0393_ _UU0394_ p =
  (case p of {
    ...
    ImpL_pfc p2 b -> (\_ _ ->
     Logic.eq_rec (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons
       (Imp p2 b) (Datatypes.Coq_cons b Datatypes.Coq_nil)) Datatypes.Coq_nil)
       (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons (Imp p2 b)
       Datatypes.Coq_nil) (Datatypes.Coq_cons p2 Datatypes.Coq_nil))
       Datatypes.Coq_nil)) (\_ ->
