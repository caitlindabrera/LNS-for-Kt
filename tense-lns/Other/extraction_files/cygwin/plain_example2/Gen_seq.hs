...
seqext :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
          a1) -> (Datatypes.Coq_list a1) -> (Gen_tacs.Coq_rel (Datatypes.Coq_list a1)) ->
...
coq_Sctxt_e ps u v _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 h =
  Logic.eq_rect (seqext _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 (Datatypes.Coq_pair u v))
    (Sctxt ps (Datatypes.Coq_pair u v) _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 h)
    (Datatypes.Coq_pair (Datatypes.app _UU03a6_1 (Datatypes.app u _UU03a6_2))
...
seqrule_same :: (Datatypes.Coq_list (Gen_tacs.Coq_rel (Datatypes.Coq_list a1))) ->
                (Gen_tacs.Coq_rel (Datatypes.Coq_list a1)) -> (Gen_tacs.Coq_rel
                (Datatypes.Coq_list a1)) -> (Coq_seqrule a1 a2) -> Coq_seqrule a1 
                a2
...
coq_InT_seqextL :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1 -> (GenT.InT
                   a1) -> Specif.Coq_sigT (Datatypes.Coq_list a1)
...
coq_InT_seqextL _UU0393_ =
  Datatypes.list_rect (\_ _ hin ->
    case hin of {
     ...
     GenT.InT_cons _ _ x -> Logic.coq_False_rect x})
              ...
              Logic.eq_rect (Datatypes.app h1 (Datatypes.Coq_cons a0 h2)) (\_ ->
                Logic.eq_rect (Datatypes.app _UU0394_ Datatypes.Coq_nil)
                  (let {
                    _evar_0_ = let {
                                _evar_0_ = let {
                                            _evar_0_ = Specif.Coq_existT
                                             (Datatypes.Coq_cons a h1) (Specif.Coq_existT
                                             h2 __)}
                                           in
                   ...
                   in
                   Logic.eq_rect_r _UU0394_ _evar_0_
                     (Datatypes.app _UU0394_ Datatypes.Coq_nil)) _UU0394_) _UU0393_0 __}})
          l) b __ x}) _UU0393_

coq_InT_seqextR :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1 -> (GenT.InT
                   a1) -> Specif.Coq_sigT (Datatypes.Coq_list a1)
                   (Specif.Coq_sigT (Datatypes.Coq_list a1) ())
              ...
              Logic.eq_rect (Datatypes.app _UU0393_ Datatypes.Coq_nil) (\_ ->
                Logic.eq_rect (Datatypes.app h1 (Datatypes.Coq_cons a0 h2))
                  (let {
                   ...
                   in
                   Logic.eq_rect_r _UU0393_ _evar_0_
                     (Datatypes.app _UU0393_ Datatypes.Coq_nil)) _UU0394_0) _UU0393_ __}})
          l) b __ x}) _UU0394_

coq_InT_seqext :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1 -> a1 ->
                  (GenT.InT a1) -> (GenT.InT a1) -> Specif.Coq_sigT
                  ...
                  Logic.eq_rect (Datatypes.app h1 (Datatypes.Coq_cons a h2))
                    (Logic.eq_rect (Datatypes.app j1 (Datatypes.Coq_cons b j2))
                      (Logic.eq_rect (Datatypes.app h1 (Datatypes.Coq_cons a h2))
                        (\_ _ _ ->
                        Logic.eq_rect (Datatypes.app j1 (Datatypes.Coq_cons b j2))
                          (\_ _ _ -> Specif.Coq_existT h1 (Specif.Coq_existT h2
                          (Specif.Coq_existT j1 (Specif.Coq_existT j2 __)))) _UU0394_ hin2
                          __ __) _UU0393_ hin1 __ __) _UU0394_) _UU0393_}
                in
                Logic.eq_rect_r _UU0393_ _evar_0_
