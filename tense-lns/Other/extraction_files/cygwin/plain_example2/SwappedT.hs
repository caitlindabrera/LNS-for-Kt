        ...
        Logic.eq_rect_r (Datatypes.app a (Datatypes.app b (Datatypes.app c d))) (\x2 _ ->
          Logic.eq_rect_r (Datatypes.app a (Datatypes.app c (Datatypes.app b d))) (\_ _ ->
            Logic.eq_rect_r
              ...
              (Datatypes.app z (Datatypes.app a (Datatypes.app b (Datatypes.app c d))))) y
            x2 __) x x0 __) y0) x1 __ __ __}
      ...
      Logic.eq_rect_r n0 (\_ ->
        Logic.eq_rect_r a (\_ ->
          Logic.eq_rect_r b (\x1 x2 -> Coq_swapped_spec_step n0 (Datatypes.app l a)
            ...
            (swapped_L b0 b l x2)) c) a0) n1 __ __ x x0}) n
          ...
          Logic.eq_rect_r l3 (\x1 x2 ->
            ...
            case h3 of {
             Specif.Coq_existT m h4 -> Specif.Coq_existT (Datatypes.S m)
              (Coq_swapped_spec_step m l1 b l3 h4 x2)}) c) a) n __ __ x x0}) n2
        ...
        Logic.eq_rect_r l2 (\_ ->
          Logic.eq_rect_r l3 (\x1 x2 ->
            ...
            (Logic.eq_rect (PeanoNat._Nat__add (Datatypes.S n1) n3) h3
              (PeanoNat._Nat__add n1 (Datatypes.S n3))) x2) c) a) n __ __ x x0}) n2
      ...
      Logic.eq_rect_r n0 (\_ ->
        Logic.eq_rect_r a (\_ ->
          Logic.eq_rect_r b (\x1 x2 ->
            ...
            let {x5 = iHn a b0 x1} in swapped_spec_trans_exact Datatypes.O n0 b b0 a x4 x5)
            c) a0) n1 __ __ x x0}) n
