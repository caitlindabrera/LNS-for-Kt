   ...
   Datatypes.Coq_pair p0 x0 ->
    case p0 of {
     Datatypes.Coq_pair p1 x1 ->
      case p1 of {
       Datatypes.Coq_pair lS1 lS2 ->
        Logic.eq_rect_r
          (Datatypes.app g1 (Datatypes.Coq_cons (Datatypes.Coq_pair seq1 d)
            Datatypes.Coq_nil)) (\d3 lS3 lS4 lS5 lS6 ->
          Logic.eq_rect_r (Datatypes.Coq_pair _UU0393_
            ...
            Logic.eq_rect_r
              (Datatypes.app g2 (Datatypes.Coq_cons (Datatypes.Coq_pair seq2 d)
                Datatypes.Coq_nil)) (\d5 lS11 lS12 lS13 lS14 ->
              Logic.eq_rect_r (Datatypes.Coq_pair
                ...
                Logic.eq_rect
                  ...
                  (Logic.eq_rect
                    (Datatypes.app g3
                      (Datatypes.app (Datatypes.Coq_cons (Datatypes.Coq_pair
                        ...
                        (Datatypes.app _UU0394_1 (Datatypes.app _UU0394_2 _UU03a0_))) d)
                        Datatypes.Coq_nil) Datatypes.Coq_nil))
                    (unsafeCoerce lS15 __ g1 _UU0393_ _UU0394_1 _UU0394_2 g2 _UU03a3_1
                  ...
                  (Datatypes.app g3 (Datatypes.Coq_cons (Datatypes.Coq_pair
                    ...
                    (Datatypes.app _UU0393_ (Datatypes.app _UU03a3_1 _UU03a3_2))
                    (Datatypes.app _UU0394_1 (Datatypes.app _UU0394_2 _UU03a0_))) d)
                    Datatypes.Coq_nil))) seq2 d5 lS14 lS13 lS12 lS11) ns2 d2 lS10 lS9 lS8
              lS7) seq1 d3 lS6 lS5 lS4 lS3) ns1 d1 lS1 lS2 x1 x0}}}
               ...
               Logic.eq_rect_r ps (\_ ->
                 Logic.eq_rect_r concl (\x1 -> DdT.Coq_derI ps concl x1
                   (DdT.dersrecI_forall ps (\p hin ->
                     ...
                     case x2 of {
                      Specif.Coq_existT d2 _ -> x (Dd_fc.derrec_height p d2) __ p d2 __})))
                   c) ps0 __ x0;
                                             ...
                                             Lnt_contraction_mrT.derrec_mergeL g
                                               ...
                                               (coq_LNSKt_cut_admissibility
                                                 ...
                                                 (x
                                                   ...
                                                   __) g g g3 (Datatypes.Coq_pair _UU0393_
                                                 (Datatypes.app _UU0394_1
                                                   (Datatypes.app (Datatypes.Coq_cons a
                                                     Datatypes.Coq_nil) _UU0394_2)))
                                                 (Datatypes.Coq_pair
                                                 (Datatypes.app _UU03a3_1
                                                   (Datatypes.app (Datatypes.Coq_cons a
                                                     Datatypes.Coq_nil) _UU03a3_2))
                                                 _UU03a0_) d1 _UU0393_ _UU0394_1 _UU0394_2
                                                 _UU03a3_1 _UU03a3_2 _UU03a0_ a hG3
                                                 (Structural_equivalence.struct_equiv_str_refl
                                                   g))}}}) c0 l2 h' __ h3 __ x4) ps1 d0 l1
                                     x3 __ __ h2) c0) ps1 __}) ps l0 d __ __ x2) concl l
                           h0 __ __ x1) concl) ps __ h1}) c) ps0 __ x0}) n1}
        in
        Logic.eq_rect_r (DdT.Coq_derI ps concl l d) _evar_0_ h0 __}}) ns h __
