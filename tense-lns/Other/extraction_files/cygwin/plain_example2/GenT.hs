  ...
  Datatypes.Coq_pair (\x0 ->
    case x0 of {
     ...
     ForallT_cons x1 l x2 x3 ->
      Logic.eq_rect_r x (\_ -> Logic.eq_rect_r Datatypes.Coq_nil (\x4 _ -> x4) l) x1 __ x2
        x3}) (\x0 -> ForallT_cons x Datatypes.Coq_nil x0 ForallT_nil)
        ...
        Logic.eq_rect_r (Datatypes.Coq_cons y Datatypes.Coq_nil) (\x4 x5 ->
          case x5 of {
           ...
           ForallT_cons x6 l0 x7 x8 ->
            Logic.eq_rect_r y (\_ ->
              Logic.eq_rect_r Datatypes.Coq_nil (\x9 _ -> Datatypes.Coq_pair x4 x9) l0) x6
              __ x7 x8}) l) x1 __ x2 x3}) (\x0 ->
    case x0 of {
    ...
    case x1 of {
     Datatypes.Coq_nil ->
      Logic.eq_rect_r a (\_ ->
        ...
        __;
     Datatypes.Coq_cons a0 x2 ->
      Logic.eq_rect_r a (\_ _ ->
        Logic.eq_rect_r (Datatypes.app x2 y0) (\_ ->
          Logic.eq_rect_r a0 (\_ -> Datatypes.Coq_inl (coq_InT_eq a0 x2)) a __) l __) b __
        __}) (\b l x1 iHX x2 y0 _ ->
    case x2 of {
     Datatypes.Coq_nil ->
      Logic.eq_rect (Datatypes.Coq_cons b l) (Datatypes.Coq_inr (InT_cons b l x1)) y0;
     Datatypes.Coq_cons a0 x3 ->
      Logic.eq_rect_r (Datatypes.app x3 y0) (\_ iHX0 _ ->
        Logic.eq_rect_r a0 (\_ ->
          ...
          case e of {
           ...
           Datatypes.Coq_inr i -> Datatypes.Coq_inr i}) b __) l x1 iHX __}) z x x0 y __
        ...
        Logic.eq_rect_r a (\_ ->
          Logic.eq_rect_r l0 (\x5 x6 ->
            case x1 of {
             ...
             InT_cons b l2 x7 ->
              Logic.eq_rect_r a (\_ -> Logic.eq_rect_r l0 (\x8 -> p x6 x0 x8) l2) b __ x7})
            l1) x2 __ x3 x4}}) (\x ->
    case iHl of {
