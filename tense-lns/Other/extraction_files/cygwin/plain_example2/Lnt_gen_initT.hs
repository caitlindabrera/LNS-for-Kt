...
coq_Id_InT :: (Datatypes.Coq_list
              ...
              a1 -> (GenT.InT (LntT.PropF a1)) -> (GenT.InT (LntT.PropF a1)) ->
              DdT.Coq_derrec
              (Datatypes.Coq_list
...
coq_Id_InT gH _UU0393_ _UU0394_ d p hin1 hin2 =
  let {s = Gen_seq.coq_InT_seqext _UU0393_ _UU0394_ (LntT.Var p) (LntT.Var p) hin1 hin2}
  in
  case s of {
       ...
       Specif.Coq_existT h3 s2 ->
        case s2 of {
         Specif.Coq_existT h4 _ -> DdT.Coq_derI
          ...
          (Datatypes.app gH (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
            _UU0393_ _UU0394_) d) Datatypes.Coq_nil)) (Lntkt_exchT.Coq_prop
          (List.map (LntT.nslcext gH d)
            (List.map (Gen_seq.seqext h1 h2 h3 h4) Datatypes.Coq_nil))
          (Datatypes.app gH (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
            _UU0393_ _UU0394_) d) Datatypes.Coq_nil)) (LntT.NSlcctxt
          (List.map (Gen_seq.seqext h1 h2 h3 h4) Datatypes.Coq_nil) (Datatypes.Coq_pair
          _UU0393_ _UU0394_) gH d
          (Gen_seq.seqrule_same (List.map (Gen_seq.seqext h1 h2 h3 h4) Datatypes.Coq_nil)
            (Gen_seq.seqext h1 h2 h3 h4 (Datatypes.Coq_pair (Datatypes.Coq_cons (LntT.Var
              p) Datatypes.Coq_nil) (Datatypes.Coq_cons (LntT.Var p) Datatypes.Coq_nil)))
            ...
            (Datatypes.Coq_cons (LntT.Var p) Datatypes.Coq_nil)) h1 h2 h3 h4 (LntT.Id_pfc
            p))))) DdT.Coq_dlNil}}}}
    ...
    case s0 of {
     Specif.Coq_existT h2 _ -> DdT.Coq_derI
      ...
      (Gen_seq.seqrule_same
        ...
        (Datatypes.Coq_pair _UU0393_ _UU0394_) (Gen_seq.Sctxt Datatypes.Coq_nil
        (Datatypes.Coq_pair (Datatypes.Coq_cons LntT.Bot Datatypes.Coq_nil)
        Datatypes.Coq_nil) h1 h2 _UU0394_ Datatypes.Coq_nil LntT.BotL_pfc))))
      DdT.Coq_dlNil}}
