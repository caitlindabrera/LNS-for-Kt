          ...
          Logic.eq_rect_r
            ...
            Logic.eq_rect_r
              ...
              (Datatypes.app a1
                (Datatypes.app (Datatypes.Coq_cons a0 Datatypes.Coq_nil)
                  (Datatypes.app b
                    (Datatypes.app (Datatypes.Coq_cons a0 Datatypes.Coq_nil) c)))))) z hc0
            ...
            Logic.eq_rect_r
              ...
              (let {
               ...
               Logic.eq_rect_r
                 ...
                 (Datatypes.app (Datatypes.Coq_cons a0 Datatypes.Coq_nil)
                   (Datatypes.app c0 (Datatypes.Coq_cons a Datatypes.Coq_nil))))) y0 c1
              hc0 iHHc __) x c __) y1) x0 __ __ __}) y z hc
...
contracted_seq_refl s =
  case s of {
   Datatypes.Coq_pair p x ->
    case p of {
     Datatypes.Coq_pair _UU0393_ _UU0394_ -> Coq_cont_seq_baseL (Datatypes.Coq_pair
      (Datatypes.Coq_pair _UU0393_ _UU0394_) x) (Datatypes.Coq_pair (Datatypes.Coq_pair
      _UU0393_ _UU0394_) x) (Coq_cont_seqL _UU0393_ _UU0393_ _UU0394_ x
      (Coq_cont_multi_refl _UU0393_))}}
...
contracted_nseq_app l1 =
  Datatypes.list_rect (\_ l3 _ h1 h2 ->
    case h1 of {
     Coq_cont_nseq_nil -> Logic.eq_rect Datatypes.Coq_nil h2 l3;
                   ...
                   Datatypes.Coq_inr hin8 ->
                    GenT.coq_InT_appR b0 a0
                      (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil)
                        (Datatypes.app b c))
                      (GenT.coq_InT_appR b0 (Datatypes.Coq_cons a Datatypes.Coq_nil)
                        (Datatypes.app b c) (GenT.coq_InT_appR b0 b c hin8))}}}}) _UU03a3_
            hc0 __) _UU0393_ hc __ hin) y) x __ __ __;
   Coq_contracted_genR_I a x y a0 b c ->
    Logic.eq_rect_r _UU0393_ (\_ ->
      Logic.eq_rect_r _UU03a3_ (\_ _ b0 hin ->
        Logic.eq_rect_r
  ...
  contracted_seq_rec (\s3 s4 c _UU0393_0 _UU0394_0 _UU03a3_0 _UU03a0_0 d3 d4 _ _ ->
    Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0 _UU0394_0) d3)
      ...
      Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU03a3_0 _UU03a0_0) d4)
        ...
        s4 c0) s3 c) (\s3 s4 c _UU0393_0 _UU0394_0 _UU03a3_0 _UU03a0_0 d3 d4 _ _ ->
    Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0 _UU0394_0) d3)
      (\c0 ->
      Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU03a3_0 _UU03a0_0) d4)
        (\c1 ->
                ...
                Logic.eq_rec_r _UU03a3_0 (\_ ->
                  Logic.eq_rec_r _UU03a0_0 (\_ ->
                    Logic.eq_rec_r d4 (\h1 ->
                      Logic.eq_rec_r _UU03a3_0 (\c2 -> Logic.eq_rec_r d4 (\_ -> h1) d3 c2)
              ...
              Logic.eq_rec_r d3 (\_ ->
                Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair y _UU0394_0) d3)
                  ...
                  Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair y _UU0394_0) d3)
                    ...
                    iHcontracted_seq0 h1) s4) d) _UU0394_1) x __ __ __ h2}) s5 h0
              ...
              Logic.eq_rec_r d3 (\_ ->
                Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0 y) d3)
                  ...
                  Logic.eq_rec (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0 y) d3)
                    ...
                    iHcontracted_seq0 h1) s4) d) x) _UU0393_1 __ __ __ h2}) s5 h0
            ...
            Logic.eq_rec_r _UU0394_0 (\_ ->
              Logic.eq_rec_r d3 (\_ ->
                Logic.eq_rec_r _UU03a3_0 (\_ ->
                  Logic.eq_rec_r _UU03a0_0 (\_ ->
                    Logic.eq_rec_r d4 (\h1 ->
                      Logic.eq_rec_r _UU03a0_0 (\c2 -> Logic.eq_rec_r d4 (\_ -> h1) d3 c2)
                        _UU0394_0 c1) d3) _UU0394_0) y __ __) d) _UU0394_1) x __ __ __ h0})
        s4 c0) s3 c) (\s3 s4 c _UU0393_0 _UU0394_0 _UU03a3_0 _UU03a0_0 d3 d4 _ _ ->
    Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_0 _UU0394_0) d3)
      (\c0 ->
