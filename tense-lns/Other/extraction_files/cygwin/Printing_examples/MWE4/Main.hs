...
instance Prelude.Show (Top.Coq_b2rrules v) where
  show (Top.WBox2Rs _ _ _ _) = "WBox2Rs"
  show (Top.BBox2Rs _ _ _ _) = "BBox2Rs"

instance Prelude.Show (Top.Coq_b1rrules v) where
  show (Top.WBox1Rs _ _ _ _ _ _ _ _) = "WBox1Rs"
  show (Top.BBox1Rs _ _ _ _ _ _ _ _) = "BBox1Rs"

instance Prelude.Show (Top.Coq_b1lrules v) where
  show (Top.WBox1Ls _ _ _ _ _ _ _ _) = "WBox1Ls"
  show (Top.BBox1Ls _ _ _ _ _ _ _ _) = "BBox1Ls"

instance Prelude.Show (Top.Coq_b2lrules v) where
  show (Top.WBox2Ls _ _ _ _ _ _ _ _) = "WBox2Ls"
  show (Top.BBox2Ls _ _ _ _ _ _ _ _) = "BBox2Ls"

instance Prelude.Show (Top.EW_rule v) where
  show (Top.EW _ _ _) = "EW"

instance (Prelude.Show v) => Prelude.Show (Top.LNSKt_rules v) where
  show (Top.Coq_b2r _ _ rl) = show rl
  show (Top.Coq_b1r _ _ rl) = show rl
  show (Top.Coq_b2l _ _ rl) = show rl
  show (Top.Coq_b1l _ _ rl) = show rl
  show (Top.Coq_nEW _ _ rl) = show rl
  show (Top.Coq_prop _ _ rl) = show rl
