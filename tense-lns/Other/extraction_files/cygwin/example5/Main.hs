...
instance (Prelude.Show v) => Prelude.Show (LntT.Coq_princrule_pfc v) where
  show (LntT.Id_pfc p) = "Id (p " Prelude.++ Prelude.show p Prelude.++ ")"
  show (LntT.ImpR_pfc a b) = "ImpR (" Prelude.++ Prelude.show a Prelude.++ ") (" Prelude.++ Prelude.show b Prelude.++ ")"
  show (LntT.ImpL_pfc a b) = "ImpL (" Prelude.++ Prelude.show a Prelude.++ ") (" Prelude.++ Prelude.show b Prelude.++ ")"
