...
coq_Lemma_Sixteen_SR_bb :: Datatypes.Coq_nat -> Datatypes.Coq_nat -> ((Datatypes.Coq_prod Datatypes.Coq_nat Datatypes.Coq_nat) -> () -> Datatypes.Coq_prod
                           ...
                           (Datatypes.Coq_list (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1))) LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules a1) 
                           ()) -> (Principal.Coq_principal_BBR a1 (Lntkt_exchT.LNSKt_rules a1) ()) -> (Structural_equivalence.Coq_struct_equiv_str a1) -> (Merge.Coq_merge
...
coq_Lemma_Sixteen_SR_bb n m iH g _UU0393_ _UU0394_1 _UU0394_2 h _UU03a3_1 _UU03a3_2 _UU03a0_ i gH a d d1 d2 d3 x x0 x1 =
  unsafeCoerce Lemma_Sixteen_setup.coq_SR_bb_fwd_bac_rev (Datatypes.Coq_pair (Datatypes.S n) m) (\_ x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 _ x17 x18 _ ->
    Lemma_Sixteen_SR_bb_fwd.coq_Lemma_Sixteen_SR_bb_fwd n m iH x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18)
    (\_ x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 _ x17 x18 _ ->
    Lemma_Sixteen_SR_bb_bac.coq_Lemma_Sixteen_SR_bb_bac n m iH x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18) __ g _UU0393_ _UU0394_1 _UU0394_2 h _UU03a3_1
