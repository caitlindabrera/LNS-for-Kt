         ...
         Datatypes.Coq_pair lS1 lS2 -> (\lS3 lS4 ->
          Logic.eq_rect_r
            ...
            Logic.eq_rect_r (Datatypes.Coq_pair _UU0393_
              ...
              Logic.eq_rect_r
                (Datatypes.app g2 (Datatypes.Coq_cons (Datatypes.Coq_pair seq2
                ...
                Logic.eq_rect_r (Datatypes.Coq_pair
                  ...
                  Logic.eq_rect
                      ...
                      (Datatypes.app g3
                        (Datatypes.app (Datatypes.Coq_cons (Datatypes.Coq_pair
                          ...
                          (Datatypes.app _UU0394_1
                            (Datatypes.app _UU0394_2 _UU03a0_))) d)
                          Datatypes.Coq_nil) Datatypes.Coq_nil))
                      (unsafeCoerce lS17 __ g1 _UU0393_ _UU0394_1 _UU0394_2 g2
                        _UU03a3_1 _UU03a3_2 _UU03a0_ Datatypes.Coq_nil g3 a d
                        d4 d6 __ __ h3 x)
                      (Datatypes.app
                        (Datatypes.app g3 (Datatypes.Coq_cons
                          (Datatypes.Coq_pair (Datatypes.Coq_pair
                    ...
                    (Datatypes.app g3 (Datatypes.Coq_cons (Datatypes.Coq_pair
                      ...
                      (Datatypes.app _UU0394_1
                        (Datatypes.app _UU0394_2 _UU03a0_))) d)
                      Datatypes.Coq_nil))) seq2 d5 lS16 lS15 lS14 lS13) ns2 d2
                lS12 lS11 lS10 lS9) seq1 d3 lS8 lS7 lS6 lS5) ns1 d1 lS1 lS2
            lS3 lS4)}) x1}) x0}

data Cut_rule v =
   Cut (Datatypes.Coq_list (LntT.PropF v)) (Datatypes.Coq_list (LntT.PropF v)) 
                        ...
                        LntT.NSlclctxt ps1 c0 g x3 -> (\_ _ ->
                         Logic.eq_rect (List.map (LntT.nslclext g) ps1) (\_ ->
                           Logic.eq_rect (LntT.nslclext g c0) (\x4 ->
                             Logic.eq_rect (LntT.nslclext g c0)
                               (\l0 h'0 _ _ x5 ->
                               Logic.eq_rect (List.map (LntT.nslclext g) ps1)
                                 (\l1 d0 _ _ x6 ->
                                 (case x4 of {
                                   Cut _UU0393_ _UU0394_1 _UU0394_2 _UU03a3_1
                                    _UU03a3_2 _UU03a0_ d1 a -> (\_ _ ->
                                    Logic.eq_rect
                                                 ...
                                                 Datatypes.Coq_pair _ _ ->
                                                  ...
                                                  case s0 of {
                                                   Specif.Coq_existT g3 hG3 ->
                                                    Lnt_contraction_mrT.derrec_mergeL
                                                      g (Datatypes.Coq_cons
                                                      (Datatypes.Coq_pair
                                                      (Datatypes.Coq_pair
                                                      (Datatypes.app _UU0393_
                                                        (Datatypes.app
                                                      ...
                                                      (coq_LNSKt_cut_admissibility
                                                        ...
                                                        (Datatypes.app
                                                          ...
                                                          (Datatypes.app
                                                            ...
                                                            Datatypes.Coq_nil)
                                                            _UU03a3_2))
                                                        _UU03a0_) d1 _UU0393_
                                                        _UU0394_1 _UU0394_2
                                                        _UU03a3_1 _UU03a3_2
                                                        _UU03a0_ a hG3
                                                        (Structural_equivalence.struct_equiv_str_refl
                                                          g))}}}}) c0 l2 h'0
                                            __ x8 __ x7) ps1 d0 l1 x6 __ __
                                          x4) c0) ps1 __)}) __ __) ps l0 d __
                                 __ x5) concl l h' __ __ x2) concl) ps __ x3)})
                        __ __) c) ps0 __ x1)}) __ __) n1}
          in
