...
coq_Sctxt_e ps u v _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 h =
  Logic.eq_rect
    ...
    (Sctxt ps (Datatypes.Coq_pair u v) _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2
    h) (Datatypes.Coq_pair
...
coq_InT_seqextL :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1 ->
                   (GenT.InT a1) -> Specif.Coq_sigT (Datatypes.Coq_list a1)
