...
data Coq_swapped t =
   Coq_swapped_I (Datatypes.Coq_list t) (Datatypes.Coq_list t) (Datatypes.Coq_list
                                                               t) (Datatypes.Coq_list
                                                                  t) 
 (Datatypes.Coq_list t) (Datatypes.Coq_list t)

swapped_I' :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
...
swapped_L :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
             (Datatypes.Coq_list a1) -> (Coq_swapped a1) -> Coq_swapped 
             a1
swapped_L x y z x0 =
  (case x0 of {
         ...
         Logic.eq_rect_r
           ...
           Logic.eq_rect_r
             ...
             Logic.eq_rect_r
               ...
               (Datatypes.app z
                 (Datatypes.app a (Datatypes.app b (Datatypes.app c d))))) y
             x2 __) x x0 __) y0) x1 __ __ __)}) __ __

swapped_R :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
             (Datatypes.Coq_list a1) -> (Coq_swapped a1) -> Coq_swapped 
             a1
swapped_R _ _ z x0 =
  case x0 of {
...
swapped_cons :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
...
swapped_comm :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
    ...
    Coq_swapped_I x y a0 b0 c d -> (\_ _ ->
     Logic.eq_rect_r a (\_ ->
       Logic.eq_rect_r b (\_ _ ->
         Logic.eq_rect_r
           (Datatypes.app a0 (Datatypes.app b0 (Datatypes.app c d)))
           (\h0 _ ->
           Logic.eq_rect_r
             (Datatypes.app a0 (Datatypes.app c (Datatypes.app b0 d)))
             (\_ _ -> swapped_I' a0 c b0 d) b h0 __) a h __) y) x __ __ __)})
    __ __

data Coq_swapped_spec t =
   Coq_swapped_spec_I (Datatypes.Coq_list t) (Datatypes.Coq_list t) (Coq_swapped
                                                                    t)
 | Coq_swapped_spec_step Datatypes.Coq_nat (Datatypes.Coq_list t) (Datatypes.Coq_list
                                                                  t) 
 (Datatypes.Coq_list t) (Coq_swapped_spec t) (Coq_swapped t)

swapped_spec_refl :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
                     Coq_swapped_spec a1
swapped_spec_refl n =
  Datatypes.nat_rect (\a -> Coq_swapped_spec_I a a (swapped_same a))
    (\n0 iHn a -> Coq_swapped_spec_step n0 a a a (iHn a) (swapped_same a)) n

swapped_app_L :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
                 (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
  ...
  Datatypes.nat_rect (\l a b hswap -> Coq_swapped_spec_I (Datatypes.app l a)
    ...
    (swapped_L a b l
      ((case hswap of {
         ...
         Coq_swapped_spec_step _ _ _ _ x x0 -> (\_ _ _ ->
          Logic.coq_False_rect __ __ x x0)}) __ __ __)))
    (\n0 iHn l a b hswap ->
    (case hswap of {
       ...
       Logic.eq_rect_r n0 (\_ ->
         Logic.eq_rect_r a (\_ ->
           Logic.eq_rect_r b (\x1 x2 -> Coq_swapped_spec_step n0
             ...
             (iHn l a b0 x1) (swapped_L b0 b l x2)) c) a0) n1 __ __ x x0)})
      __ __ __) n

swapped_spec_trans :: Datatypes.Coq_nat -> Datatypes.Coq_nat ->
                      (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                      a1) -> (Datatypes.Coq_list a1) -> (Coq_swapped_spec 
                      a1) -> (Coq_swapped_spec a1) -> Specif.Coq_sigT
...
swapped_spec_trans_exact :: Datatypes.Coq_nat -> Datatypes.Coq_nat ->
                            (Datatypes.Coq_list a1) -> (Datatypes.Coq_list
         ...
         Logic.eq_rect_r l2 (\_ ->
           Logic.eq_rect_r l3 (\x1 x2 ->
             ...
             (Logic.eq_rect (PeanoNat._Nat__add (Datatypes.S n1) n3) h3
               (PeanoNat._Nat__add n1 (Datatypes.S n3))) x2) c) a) n __ __ x
         x0)}) __ __ __) n2

swapped_spec_comm :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
       ...
       Logic.eq_rect_r n0 (\_ ->
         Logic.eq_rect_r a (\_ ->
           Logic.eq_rect_r b (\x1 x2 ->
             ...
             swapped_spec_trans_exact Datatypes.O n0 b b0 a x4 x5) c) a0) n1
         __ __ x x0)}) __ __ __) n

swapped_spec_conv :: Datatypes.Coq_nat -> Datatypes.Coq_nat ->
                     (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                     (Coq_swapped_spec a1) -> Coq_swapped_spec a1
swapped_spec_conv n m _ _ x =
  Logic.eq_rect_r m (\x0 -> x0) n x

swapped_app_mid_L :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
                     (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                     (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                     (Coq_swapped_spec a1) -> Coq_swapped_spec a1
...
swapped_app_mid_R :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
                     (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                     (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                     (Coq_swapped_spec a1) -> Coq_swapped_spec a1
...
swapped_spec_front_mid :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
                          (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                          a1) -> (Datatypes.Coq_list a1) -> (Coq_swapped_spec
                          a1) -> Specif.Coq_sigT Datatypes.Coq_nat
                          (Coq_swapped_spec a1)
swapped_spec_front_mid n a b c d hswap =
  ...
  swapped_spec_trans n (Datatypes.S Datatypes.O) (Datatypes.app a b)
    ...
    (Logic.eq_rect
      (Datatypes.app Datatypes.Coq_nil (Datatypes.app c (Datatypes.app a d)))
...
swapped__n_mid :: Datatypes.Coq_nat -> (Datatypes.Coq_list a1) ->
                  (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                  (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
...
swapped__n_mid m l _UU0393_1 _UU0393_2 _UU0393_1' _UU0393_2' h =
  ...
  (Logic.eq_rect
    ...
    (Logic.eq_rect
      (Datatypes.app Datatypes.Coq_nil
        (Datatypes.app _UU0393_1' (Datatypes.app l _UU0393_2')))
      (swapped_app_mid_R (Datatypes.S m) Datatypes.Coq_nil l _UU0393_1'
        _UU0393_2'
        (Datatypes.app Datatypes.Coq_nil
          (Datatypes.app _UU0393_1 (Datatypes.app l _UU0393_2)))
...
swapped_gen_front_mid :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                         a1) -> (Datatypes.Coq_list a1) ->
                         (Datatypes.Coq_list a1) -> (Coq_swapped_gen 
...
swapped_gen_app_L :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                     (Datatypes.Coq_list a1) -> (Coq_swapped_gen a1) ->
                     Coq_swapped_gen a1
