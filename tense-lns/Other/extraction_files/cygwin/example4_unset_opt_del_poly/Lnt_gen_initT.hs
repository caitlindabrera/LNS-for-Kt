...
coq_Id_InT :: (Datatypes.Coq_list
              ...
              (LntT.PropF a1)) -> (GenT.InT (LntT.PropF a1)) ->
              DdT.Coq_derrec
              (Datatypes.Coq_list
              (Datatypes.Coq_prod
...
coq_Id_InT gH _UU0393_ _UU0394_ d p hin1 hin2 =
  let {
   s = Gen_seq.coq_InT_seqext _UU0393_ _UU0394_ (LntT.Var p) (LntT.Var p)
         hin1 hin2}
  in
  case s of {
...
coq_BotL_InT :: (Datatypes.Coq_list
                ...
                (Datatypes.Coq_list (LntT.PropF a1))) LntT.Coq_dir)) ->
                (Datatypes.Coq_list (LntT.PropF a1)) -> (Datatypes.Coq_list
                (LntT.PropF a1)) -> LntT.Coq_dir -> (GenT.InT
    ...
    case s0 of {
     Specif.Coq_existT h2 _ -> DdT.Coq_derI
      ...
      (Gen_seq.seqrule_same
        ...
        Datatypes.Coq_nil LntT.BotL_pfc)))) DdT.Coq_dlNil}}
