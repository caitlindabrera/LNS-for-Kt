              ...
              Datatypes.Coq_inl s ->
               case s of {
                Specif.Coq_existT l10 _ ->
                 Logic.eq_rect_r
                   (Datatypes.app l9 (Datatypes.Coq_cons c l10)) (\_ _ ->
                   Logic.eq_rect_r
              ...
              Datatypes.Coq_inr s ->
               case s of {
                ...
                Datatypes.Coq_inr s0 ->
                 Logic.eq_rect_r
                   (Datatypes.app l5 (Datatypes.Coq_cons b0 s0)) (\_ ->
                   Logic.eq_rect_r
     ...
     Datatypes.Coq_inl _ ->
      Logic.eq_rect_r Datatypes.Coq_nil
        (Logic.eq_rect_r (Datatypes.Coq_cons a (Datatypes.app w0 x0))
          (Specif.Coq_existT (Datatypes.Coq_cons a w0) (Datatypes.Coq_inl
          __)) z0) y0;
     Datatypes.Coq_inr s ->
      case s of {
...
app_eq_appT2_single_tlL x y z w =
  ...
  case s of {
   Datatypes.Coq_inl _ ->
    Logic.eq_rect_r Datatypes.Coq_nil (\_ ->
      Logic.eq_rect
        (Datatypes.app x (Datatypes.Coq_cons w Datatypes.Coq_nil))
