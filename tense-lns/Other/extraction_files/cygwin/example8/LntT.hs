...
nslcext g d seq =
  Datatypes.app g (Datatypes.Coq_cons (Datatypes.Coq_pair seq d)
    Datatypes.Coq_nil)
...
princrule_pfc_LT :: (Datatypes.Coq_list
                    ...
                    (Datatypes.Coq_list (PropF a1)) -> (Datatypes.Coq_list
                    (PropF a1)) -> (Coq_princrule_pfc a1) ->
                    Datatypes.Coq_sum () (PropF a1)
    ...
    Id_pfc p0 -> (\_ _ ->
     Logic.eq_rec Datatypes.Coq_nil (\_ ->
       Logic.eq_rec (Datatypes.Coq_cons (Var p0) Datatypes.Coq_nil) (\_ ->
         Logic.eq_rec (Datatypes.Coq_cons (Var p0) Datatypes.Coq_nil)
           (Datatypes.Coq_inr (Var p0)) _UU0394_) _UU0393_ __) ps __);
    ImpR_pfc p2 b -> (\_ _ ->
     Logic.eq_rec (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons
       p2 Datatypes.Coq_nil) (Datatypes.Coq_cons (Imp p2 b)
       (Datatypes.Coq_cons b Datatypes.Coq_nil))) Datatypes.Coq_nil) (\_ ->
       Logic.eq_rec Datatypes.Coq_nil (\_ ->
         Logic.eq_rec (Datatypes.Coq_cons (Imp p2 b) Datatypes.Coq_nil)
           (Datatypes.Coq_inl __) _UU0394_) _UU0393_ __) ps __);
    ImpL_pfc a b -> (\_ _ ->
     Logic.eq_rec (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons
       (Imp a b) (Datatypes.Coq_cons b Datatypes.Coq_nil)) Datatypes.Coq_nil)
       (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons (Imp a b)
       Datatypes.Coq_nil) (Datatypes.Coq_cons a Datatypes.Coq_nil))
       Datatypes.Coq_nil)) (\_ ->
       Logic.eq_rec (Datatypes.Coq_cons (Imp a b) Datatypes.Coq_nil) (\_ ->
         Logic.eq_rec Datatypes.Coq_nil (Datatypes.Coq_inr (Imp a b))
           _UU0394_) _UU0393_ __) ps __);
    BotL_pfc -> (\_ _ ->
     Logic.eq_rec Datatypes.Coq_nil (\_ ->
       Logic.eq_rec (Datatypes.Coq_cons Bot Datatypes.Coq_nil) (\_ ->
         Logic.eq_rec Datatypes.Coq_nil (Datatypes.Coq_inr Bot) _UU0394_)
         _UU0393_ __) ps __)}) __ __
...
princrule_pfc_RT ps _UU0393_ _UU0394_ p =
  (case p of {
    ...
    ImpR_pfc a b -> (\_ _ ->
     Logic.eq_rec (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons
       a Datatypes.Coq_nil) (Datatypes.Coq_cons (Imp a b) (Datatypes.Coq_cons
       b Datatypes.Coq_nil))) Datatypes.Coq_nil) (\_ ->
       Logic.eq_rec Datatypes.Coq_nil (\_ ->
         Logic.eq_rec (Datatypes.Coq_cons (Imp a b) Datatypes.Coq_nil)
           (Datatypes.Coq_inr (Imp a b)) _UU0394_) _UU0393_ __) ps __);
    ImpL_pfc p2 b -> (\_ _ ->
     Logic.eq_rec (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_cons
       (Imp p2 b) (Datatypes.Coq_cons b Datatypes.Coq_nil))
       Datatypes.Coq_nil) (Datatypes.Coq_cons (Datatypes.Coq_pair
       (Datatypes.Coq_cons (Imp p2 b) Datatypes.Coq_nil) (Datatypes.Coq_cons
       p2 Datatypes.Coq_nil)) Datatypes.Coq_nil)) (\_ ->
       Logic.eq_rec (Datatypes.Coq_cons (Imp p2 b) Datatypes.Coq_nil) (\_ ->
         Logic.eq_rec Datatypes.Coq_nil (Datatypes.Coq_inl __) _UU0394_)
         _UU0393_ __) ps __);
    BotL_pfc -> (\_ _ ->
     Logic.eq_rec Datatypes.Coq_nil (\_ ->
       Logic.eq_rec (Datatypes.Coq_cons Bot Datatypes.Coq_nil) (\_ ->
...
princrule_pfc_L_oeT :: (Datatypes.Coq_list
                       (Gen_tacs.Coq_rel (Datatypes.Coq_list (PropF a1)))) ->
                       (Datatypes.Coq_list (PropF a1)) -> (Datatypes.Coq_list
                       (PropF a1)) -> (Datatypes.Coq_list (PropF a1)) ->
                       (Coq_princrule_pfc a1) -> Datatypes.Coq_sum () 
                       ()
...
princrule_pfc_R_oeT ps x y _UU0393_ h =
  ...
  case h0 of {
   Datatypes.Coq_inl _ ->
    Datatypes.prod_rec (\_ _ -> Datatypes.Coq_inl __) __;
   Datatypes.Coq_inr h1 ->
    let {h2 = Gen_tacs.app_eq_unitT x y h1} in
    Datatypes.sum_rec (\_ -> Logic.and_rec (\_ _ -> Datatypes.Coq_inl __))
      (\_ -> Logic.and_rec (\_ _ -> Datatypes.Coq_inr __)) h2}
