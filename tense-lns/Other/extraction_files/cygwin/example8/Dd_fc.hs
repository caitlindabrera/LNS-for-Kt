         ...
         Logic.eq_rect_r seqs (\x1 ->
           ...
           case x2 of {
            Specif.Coq_existT d2 hin2 -> Specif.Coq_existT d2
             (Coq_in_dersrec_tl seq d seqs ds0 hin2)}) l) b __ x0)}) __) cs
    ds
...
dersrec_derrec_height :: Datatypes.Coq_nat -> a1 -> (DdT.Coq_dersrec 
     ...
     Logic.eq_rect_r (DdT.Coq_dlCons seq seqs d d3) (\_ ->
       Logic.eq_rect
         ...
         (Logic.eq_rect_r g (\_ d0 ->
           Logic.eq_rect_r Datatypes.Coq_nil (\_ _ -> Specif.Coq_existT d0
             __) seqs __ d3) seq __ d) n) d2' __)}) __ d2 __ __
          ...
          Datatypes.Coq_nil -> (\_ d5 d2'1 _ _ ->
           let {
            s = dersrec_derrec_height
                  (dersrec_height (Datatypes.Coq_cons x Datatypes.Coq_nil)
                    d5) x d5}
           in
           case s of {
            Specif.Coq_existT x0 _ ->
             Logic.eq_rect_r (DdT.Coq_dlCons seq (Datatypes.Coq_cons x
               ...
               Logic.eq_rect
                 (dersrec_height (Datatypes.Coq_cons seq (Datatypes.Coq_cons
                   x Datatypes.Coq_nil)) (DdT.Coq_dlCons seq
                   (Datatypes.Coq_cons x Datatypes.Coq_nil) d d5))
