...
seqrule_id :: (Datatypes.Coq_list (Gen_tacs.Coq_rel (Datatypes.Coq_list a1)))
              -> (Gen_tacs.Coq_rel (Datatypes.Coq_list a1)) -> a2 ->
              Coq_seqrule a1 a2
seqrule_id ps c x =
  (case c of {
    Datatypes.Coq_pair ca cs -> (\x0 ->
     coq_Sctxt_eq ps ps ca cs ca cs Datatypes.Coq_nil Datatypes.Coq_nil
       Datatypes.Coq_nil Datatypes.Coq_nil x0)}) x
