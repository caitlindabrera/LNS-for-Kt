...
data Coq_seqrule w pr =
   Sctxt (([]) (Gen_tacs.Coq_rel (([]) w))) (Gen_tacs.Coq_rel (([]) w)) 
 (([]) w) (([]) w) (([]) w) (([]) w) pr

coq_Sctxt_e :: (([]) (Gen_tacs.Coq_rel (([]) a1))) -> (([]) a1) -> (([]) 
               a1) -> (([]) a1) -> (([]) a1) -> (([]) a1) -> (([]) a1) -> a2
               -> Coq_seqrule a1 a2
coq_Sctxt_e ps u v _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 h =
  Logic.eq_rect (seqext _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 ((,) u v))
    (Sctxt ps ((,) u v) _UU03a6_1 _UU03a6_2 _UU03a8_1 _UU03a8_2 h) ((,)
    (Datatypes.app _UU03a6_1 (Datatypes.app u _UU03a6_2))
    (Datatypes.app _UU03a8_1 (Datatypes.app v _UU03a8_2)))

coq_Sctxt_eq :: (([]) (Gen_tacs.Coq_rel (([]) a1))) -> (([])
                ((,) (([]) a1) (([]) a1))) -> (([]) a1) -> (([]) a1) -> (([])
                a1) -> (([]) a1) -> (([]) a1) -> (([]) a1) -> (([]) a1) ->
...
seqrule_same :: (([]) (Gen_tacs.Coq_rel (([]) a1))) -> (Gen_tacs.Coq_rel
                (([]) a1)) -> (Gen_tacs.Coq_rel (([]) a1)) -> (Coq_seqrule 
                a1 a2) -> Coq_seqrule a1 a2
seqrule_same _ c c' x =
  Logic.eq_rect_r c' (\x0 -> x0) c x

coq_InT_seqextL :: (([]) a1) -> (([]) a1) -> a1 -> (GenT.InT a1) ->
     ...
     GenT.InT_eq' b l ->
      Logic.eq_rect_r a (\_ ->
        Logic.eq_rect_r _UU0393_0 (\_ ->
          Logic.eq_rect_r a0 (\_ _ -> Specif.Coq_existT ([])
                    ...
                    _evar_0_ = let {
                                _evar_0_ = let {
                                            _evar_0_ = Specif.Coq_existT ((:)
                                             a h1) (Specif.Coq_existT h2 __)}
                                           in
                                           Logic.eq_rect_r _UU0394_ _evar_0_
                                             (Datatypes.app _UU0394_ ([]))}
                               in
                               Logic.eq_rect_r ([]) _evar_0_
                                 (Datatypes.app ([]) ([]))}
                   in
                   Logic.eq_rect_r _UU0394_ _evar_0_
                     (Datatypes.app _UU0394_ ([]))) _UU0394_) _UU0393_0 __}})
          l) b __ x}) _UU0393_

coq_InT_seqextR :: (([]) a1) -> (([]) a1) -> a1 -> (GenT.InT a1) ->
                   Specif.Coq_sigT (([]) a1) (Specif.Coq_sigT (([]) a1) ())
              ...
              Logic.eq_rect (Datatypes.app _UU0393_ ([])) (\_ ->
                Logic.eq_rect (Datatypes.app h1 ((:) a0 h2))
                  (let {
                   ...
                   in
                   Logic.eq_rect_r _UU0393_ _evar_0_
                     (Datatypes.app _UU0393_ ([]))) _UU0394_0) _UU0393_ __}})
          l) b __ x}) _UU0394_

coq_InT_seqext :: (([]) a1) -> (([]) a1) -> a1 -> a1 -> (GenT.InT a1) ->
                  (GenT.InT a1) -> Specif.Coq_sigT (([]) a1)
                  (Specif.Coq_sigT (([]) a1)
                  (Specif.Coq_sigT (([]) a1) (Specif.Coq_sigT (([]) a1) ())))
                  ...
                  Logic.eq_rect (Datatypes.app h1 ((:) a h2))
                    (Logic.eq_rect (Datatypes.app j1 ((:) b j2))
                      (Logic.eq_rect (Datatypes.app h1 ((:) a h2)) (\_ _ _ ->
                        Logic.eq_rect (Datatypes.app j1 ((:) b j2)) (\_ _ _ ->
                          Specif.Coq_existT h1 (Specif.Coq_existT h2
                          (Specif.Coq_existT j1 (Specif.Coq_existT j2 __))))
                          _UU0394_ hin2 __ __) _UU0393_ hin1 __ __) _UU0394_)
                    _UU0393_}
                in
                Logic.eq_rect_r _UU0393_ _evar_0_
                  (Datatypes.app _UU0393_ ([])) __}
              in
