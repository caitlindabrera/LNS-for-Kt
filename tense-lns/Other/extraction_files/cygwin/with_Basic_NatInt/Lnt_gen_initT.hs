        ...
        case s2 of {
         Specif.Coq_existT h4 _ -> DdT.Coq_derI
          (List.map (LntT.nslcext gH d)
            (List.map (Gen_seq.seqext h1 h2 h3 h4) ([])))
          (Datatypes.app gH ((:) ((,) ((,) _UU0393_ _UU0394_) d) ([])))
          (Lntkt_exchT.Coq_prop
          (List.map (LntT.nslcext gH d)
            (List.map (Gen_seq.seqext h1 h2 h3 h4) ([])))
          (Datatypes.app gH ((:) ((,) ((,) _UU0393_ _UU0394_) d) ([])))
          (LntT.NSlcctxt (List.map (Gen_seq.seqext h1 h2 h3 h4) ([])) ((,)
          _UU0393_ _UU0394_) gH d
          (Gen_seq.seqrule_same (List.map (Gen_seq.seqext h1 h2 h3 h4) ([]))
            (Gen_seq.seqext h1 h2 h3 h4 ((,) ((:) (LntT.Var p) ([])) ((:)
              (LntT.Var p) ([])))) ((,) _UU0393_ _UU0394_) (Gen_seq.Sctxt ([])
            ((,) ((:) (LntT.Var p) ([])) ((:) (LntT.Var p) ([]))) h1 h2 h3 h4
            (LntT.Id_pfc p))))) DdT.Coq_dlNil}}}}
   ...
   Specif.Coq_existT h1 s0 ->
    case s0 of {
     Specif.Coq_existT h2 _ -> DdT.Coq_derI
      (List.map (LntT.nslcext gH d)
        (List.map (Gen_seq.seqext h1 h2 _UU0394_ ([])) ([])))
      (Datatypes.app gH ((:) ((,) ((,) _UU0393_ _UU0394_) d) ([])))
      (Lntkt_exchT.Coq_prop
      (List.map (LntT.nslcext gH d)
        (List.map (Gen_seq.seqext h1 h2 _UU0394_ ([])) ([])))
      (Datatypes.app gH ((:) ((,) ((,) _UU0393_ _UU0394_) d) ([])))
      (LntT.NSlcctxt (List.map (Gen_seq.seqext h1 h2 _UU0394_ ([])) ([])) ((,)
      _UU0393_ _UU0394_) gH d
      (Gen_seq.seqrule_same
        (List.map (Gen_seq.seqext h1 h2 _UU0394_ ([])) ([]))
        (Gen_seq.seqext h1 h2 _UU0394_ ([]) ((,) ((:) LntT.Bot ([])) ([])))
        ((,) _UU0393_ _UU0394_) (Gen_seq.Sctxt ([]) ((,) ((:) LntT.Bot ([]))
        ([])) h1 h2 _UU0394_ ([]) LntT.BotL_pfc)))) DdT.Coq_dlNil}}
