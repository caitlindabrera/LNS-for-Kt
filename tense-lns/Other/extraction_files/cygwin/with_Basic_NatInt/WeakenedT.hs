...
data Coq_weakened_multi t =
 ...
 | Coq_weak_multi_step (([]) t) (([]) t) (([]) t) (Coq_weakened t) (Coq_weakened_multi
                                                                   t)

weakened_multi_rect :: ((([]) a1) -> a2) -> ((([]) a1) -> (([]) a1) -> (([])
...
weakened_multi_rect f f0 _ _ w =
  case w of {
   ...
   Coq_weak_multi_step x y z w0 w1 ->
    f0 x y z w0 w1 (weakened_multi_rect f f0 y z w1)}

data Coq_weakened_seqL t =
   Coq_weak_seqL (([]) t) (([]) t) (([]) t) LntT.Coq_dir (Coq_weakened_multi
                                                         t)

data Coq_weakened_seqR t =
   Coq_weak_seqR (([]) t) (([]) t) (([]) t) LntT.Coq_dir (Coq_weakened_multi
                                                         t)

data Coq_weakened_seq t =
   Coq_weak_seq_baseL ((,) ((,) (([]) t) (([]) t)) LntT.Coq_dir) ((,)
                                                                 ((,) 
                                                                 (([]) t)
                                                                 (([]) t))
                                                                 LntT.Coq_dir) 
 (Coq_weakened_seqL t)
 | Coq_weak_seq_baseR ((,) ((,) (([]) t) (([]) t)) LntT.Coq_dir) ((,)
                                                                 ((,) 
                                                                 (([]) t)
                                                                 (([]) t))
                                                                 LntT.Coq_dir) 
 (Coq_weakened_seqR t)
 | Coq_weak_seq_baseLR ((,) ((,) (([]) t) (([]) t)) LntT.Coq_dir) ((,)
                                                                  ((,)
                                                                  (([]) t)
                                                                  (([]) t))
                                                                  LntT.Coq_dir) 
 ((,) ((,) (([]) t) (([]) t)) LntT.Coq_dir) (Coq_weakened_seqL t) (Coq_weakened_seqR
                                                                  t)

data Coq_weakened_nseq t =
   Coq_weak_nseq_nil
 | Coq_weak_nseq_cons ((,) ((,) (([]) t) (([]) t)) LntT.Coq_dir) ((,)
                                                                 ((,) 
                                                                 (([]) t)
                                                                 (([]) t))
                                                                 LntT.Coq_dir) 
...
weakened_cons :: (([]) a1) -> (([]) a1) -> a1 -> (Coq_weakened a1) ->
                 Coq_weakened a1
        ...
        Logic.eq_rect_r (Datatypes.app a0 c) (\hc0 _ ->
          Logic.eq_rect_r (Datatypes.app a0 (Datatypes.app b c)) (\_ _ ->
            Logic.eq_rect_r (Datatypes.app ((:) a a0) c)
              (Logic.eq_rect_r (Datatypes.app ((:) a a0) (Datatypes.app b c))
                (Coq_weakened_I (Datatypes.app ((:) a a0) c)
                (Datatypes.app ((:) a a0) (Datatypes.app b c)) ((:) a a0) b c)
                ((:) a (Datatypes.app a0 (Datatypes.app b c)))) ((:) a
              (Datatypes.app a0 c))) z hc0 __) y hc __) y0) x __ __ __}

weakened_multi_cons :: (([]) a1) -> (([]) a1) -> a1 -> (Coq_weakened_multi 
                       a1) -> Coq_weakened_multi a1
weakened_multi_cons y z a hc =
  weakened_multi_rect (\x -> Coq_weak_multi_refl ((:) a x))
    (\x y0 z0 w _ iHHc -> Coq_weak_multi_step ((:) a x) ((:) a y0) ((:) a z0)
    (weakened_cons x y0 a w) iHHc) y z hc

weakened_multi_L :: (([]) a1) -> (([]) a1) -> (([]) a1) -> (Coq_weakened_multi
                    a1) -> Coq_weakened_multi a1
weakened_multi_L x =
...
weakened_seq_refl :: ((,) ((,) (([]) a1) (([]) a1)) LntT.Coq_dir) ->
                     Coq_weakened_seq a1
weakened_seq_refl s =
  case s of {
   (,) p x ->
    case p of {
     (,) _UU0393_ _UU0394_ -> Coq_weak_seq_baseL ((,) ((,) _UU0393_ _UU0394_)
      x) ((,) ((,) _UU0393_ _UU0394_) x) (Coq_weak_seqL _UU0393_ _UU0393_
      _UU0394_ x (Coq_weak_multi_refl _UU0393_))}}

weakened_nseq_refl :: (([]) ((,) ((,) (([]) a1) (([]) a1)) LntT.Coq_dir)) ->
...
weak_appL x y =
  Logic.eq_rect (Datatypes.app y ([]))
    (Logic.eq_rect (Datatypes.app x ([])) (Coq_weakened_I
      (Datatypes.app x ([]))
      (Datatypes.app (Datatypes.app x ([])) (Datatypes.app y ([]))) x y ([]))
      x) y

weak_appR :: (([]) a1) -> (([]) a1) -> Coq_weakened a1
weak_appR x y =
  Logic.eq_rect (Datatypes.app ([]) x)
    (Logic.eq_rect (Datatypes.app ([]) y) (Coq_weakened_I
      (Datatypes.app ([]) y)
      (Datatypes.app (Datatypes.app ([]) x) (Datatypes.app ([]) y)) ([]) x y)
      y) x
      ...
      Logic.eq_rect_r a (\_ ->
        Logic.eq_rect_r l2 (\_ ->
          Logic.eq_rect ((:) s2 ns2) (\x1 x2 ->
            Logic.eq_rect ((:) s2 ns2) (\_ -> Coq_weak_nseq_cons a s2
...
weakened_consL a b =
  Logic.eq_rect_r (Datatypes.app ((:) b ([])) a) (Coq_weakened_I a
    (Datatypes.app ((:) b ([])) a) ([]) ((:) b ([])) a) ((:) b a)

weakened_multi_appL :: (([]) a1) -> (([]) a1) -> Coq_weakened_multi a1
weakened_multi_appL a b =
  Datatypes.list_rect (Coq_weak_multi_refl (Datatypes.app ([]) a))
    (\a0 b0 iHB -> Coq_weak_multi_step a ((:) a0 a) ((:) a0
    (Datatypes.app b0 a)) (weakened_consL a a0)
    (weakened_multi_cons a (Datatypes.app b0 a) a0 iHB)) b

weak_L :: (([]) a1) -> (([]) a1) -> (([]) a1) -> (Coq_weakened a1) ->
          Coq_weakened a1
weak_L _ _ z x0 =
  case x0 of {
...
weak_R :: (([]) a1) -> (([]) a1) -> (([]) a1) -> (Coq_weakened a1) ->
          Coq_weakened a1
weak_R _ _ z x0 =
  case x0 of {
   Coq_weakened_I x y a b c ->
...
weak_cons :: a1 -> (([]) a1) -> (([]) a1) -> (Coq_weakened a1) -> Coq_weakened
             a1
weak_cons x _ _ x0 =
  case x0 of {
            ...
            (Logic.eq_rect_r (Datatypes.app ((:) x (Datatypes.app a b)) c)
              (Logic.eq_rect_r (Datatypes.app ((:) x a) b)
                (Logic.eq_rect (Datatypes.app ((:) x a) (Datatypes.app b c))
                  (weakened_I' ((:) x a) b c c)
                  (Datatypes.app (Datatypes.app ((:) x a) b) c)) ((:) x
                (Datatypes.app a b))) ((:) x
              (Datatypes.app (Datatypes.app a b) c))) ((:) x
...
weakened_seq_appL :: (([]) a1) -> (([]) a1) -> (([]) a1) -> (([]) a1) ->
                     LntT.Coq_dir -> Coq_weakened_seq a1
weakened_seq_appL a b l1 l2 d =
  Coq_weak_seq_baseLR ((,) ((,) a b) d) ((,) ((,) (Datatypes.app l1 a) b) d)
    ((,) ((,) (Datatypes.app l1 a) (Datatypes.app l2 b)) d) (Coq_weak_seqL a
    (Datatypes.app l1 a) b d (weakened_multi_appL a l1)) (Coq_weak_seqR b
