...
gen_swapL_step_loe_lc :: (([])
                         (([])
                         ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1)))
                         LntT.Coq_dir))) -> (([])
                         ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1)))
                         LntT.Coq_dir)) -> (LntT.Coq_rules_L_oeT
                         ...
                         LntT.Coq_dir)) (LntacsT.Coq_can_gen_swapL a1 a4)) ->
                         (Gen.Coq_rsub
                         (([])
                         (([])
                         ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1)))
                                ...
                                (Logic.eq_rect_r _UU0393_ (\acm2 _ ->
                                  Logic.eq_rect_r _UU0394_0 (\acm3 _ ->
                                    ...
                                    (List.map
                                      (LntT.nslcext
                                        (Datatypes.app g1 ((:) ((,) ((,)
                                          _UU0393_' _UU0394_0) d1) pp1)) d0)
                                      ps0)
                                    (Datatypes.app g1 ((:) ((,) ((,) _UU0393_'
                                      _UU0394_0) d1)
                                      (Datatypes.app pp1 ((:) ((,) ((,) l l0)
                                        d0) ([])))))
                                    (unsafeCoerce rs0
                                      (List.map
                                        (LntT.nslcext
                                                ...
                                                Logic.eq_rect
                                                  ...
                                                  (Datatypes.app
                                                    (Datatypes.app g1 ((:)
                                                      ...
                                                      _UU0394_0) d1) pp1))
                                                    ((:) ((,) x2 d0) ([])))) q}})}))
                                    seq2 acm2 __) seq1 acm1 __) seq2) seq1 __)
                            k0) g0 acm0) ps acm};
                   Prelude.Right pp0 ->
                    case pp0 of {
                     Prelude.Left _ ->
                                                       ...
                                                       (,) l1 l2 ->
                                                        Logic.eq_rect
                                                          ...
                                                          Logic.eq_rect
                                                            ...
                                                            __) ps0 acm1 sppc4})
                                                      ((,) _UU0393_ _UU0394_0))
                                                    ps0 __ pr}) seq2 sppc3 __
                                                __) seq1 sppc2 __ __) d0 acm0
                                            __) l0 sppc1 __) l sppc0 __) seq2)
                                    seq1 __) d0) l0) l __ __) k0) g1) ps acm;
                     Prelude.Right pp1 ->
                      Logic.eq_rect (List.map (LntT.nslcext g0 d0) ps0) (\_ ->
                        Logic.eq_rect_r
