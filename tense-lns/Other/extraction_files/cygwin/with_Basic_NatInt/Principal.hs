...
data Coq_principal_WBR v rules prems =
   Coq_princ_WB1Rs (([]) (LntT.PropF v)) (([]) (LntT.PropF v)) (([])
                                                               (LntT.PropF v)) 
...
data Coq_principal_BBR v rules prems =
   Coq_princ_BB1Rs (([]) (LntT.PropF v)) (([]) (LntT.PropF v)) (([])
                                                               (LntT.PropF v)) 
 (Coq_principal_BBox1Rs v rules prems)
 | Coq_princ_BB2Rs (Coq_principal_BBox2Rs v rules prems)

data Coq_principal_not_box_R v =
   Coq_princ_nb_Id (([]) (LntT.PropF v)) (([]) (LntT.PropF v)) (Coq_principal_Id_pfc
                                                               v
                                                               (Lntkt_exchT.LNSKt_rules
                                                               v) ())
 | Coq_princ_nb_ImpR (([]) (LntT.PropF v)) (([]) (LntT.PropF v)) (Coq_principal_ImpR
                                                                 v
                                                                 (Lntkt_exchT.LNSKt_rules
                                                                 v) ())
...
principal_WBR_fwd :: (([])
                     ...
                     (Lntkt_exchT.LNSKt_rules a1) ()) -> Coq_principal_WBox2Rs
   ...
   Coq_princ_WB1Rs _UU03a3_0 _UU03a0_1 _UU03a0_2 x ->
    case x of {
     Coq_princ_WB1Rs_I g' h0 b d0 d2 rl ->
      Logic.eq_rect_r
        (Datatypes.app h ((:) ((,) ((,) _UU03a3_ _UU03a0_) LntT.Coq_fwd)
          ([]))) (\d1 hprinc0 x0 rl0 _ _ ->
        Logic.eq_rect_r (LntT.WBox b) (\hprinc1 x1 _ ->
          Logic.eq_rect_r
            (List.map (LntT.nslclext g') ((:) ((:) ((,) ((,) _UU03a3_0
              (Datatypes.app _UU03a0_1 (Datatypes.app ((:) b ([])) _UU03a0_2)))
              d0) ((:) ((,) ((,) _UU0393_
              (Datatypes.app _UU0394_1
                (Datatypes.app ((:) (LntT.WBox b) ([])) _UU0394_2)))
            ...
            Logic.eq_rect_r (DdT.Coq_derI
              ...
              Logic.eq_rect_r
                ...
                (Datatypes.app g'
                  (Datatypes.app ((:) ((,) ((,) _UU03a3_0
                    (Datatypes.app _UU03a0_1 _UU03a0_2)) d0) ([])) ((:) ((,)
                    ((,) _UU0393_
                    (Datatypes.app _UU0394_1
                      (Datatypes.app ((:) (LntT.WBox b) ([])) _UU0394_2)))
                    LntT.Coq_bac) ([])))) __) d1 hprinc1 x1) h0 d2 rl0 __) a
   ...
   Coq_princ_WB2Rs x ->
    case x of {
     Coq_princ_WB2Rs_I g' h0 b d2 rl ->
      Logic.eq_rect_r
        (Datatypes.app h ((:) ((,) ((,) _UU03a3_ _UU03a0_) LntT.Coq_bac)
        ...
        Logic.eq_rect_r (LntT.WBox b) (\hprinc1 x1 _ ->
          Logic.eq_rect_r
            ...
            Logic.eq_rect_r (DdT.Coq_derI
              ...
              Logic.eq_rect_r
                (Datatypes.app
                  (Datatypes.app _UU0394_1 ((:) (LntT.WBox b) ([])))
                  _UU0394_2) _evar_0_
                (Datatypes.app _UU0394_1
                  (Datatypes.app ((:) (LntT.WBox b) ([])) _UU0394_2)) __) d0
      ...
      Logic.eq_rect_r
        ...
        Logic.eq_rect_r (LntT.BBox b) (\hprinc1 x1 _ ->
          Logic.eq_rect_r
            (List.map (LntT.nslclext g') ((:) ((:) ((,) ((,) _UU0393_
              (Datatypes.app _UU0394_1
                (Datatypes.app ((:) (LntT.BBox b) ([])) _UU0394_2)))
            ...
            Logic.eq_rect_r (DdT.Coq_derI
              ...
              Logic.eq_rect_r
                (Datatypes.app
                  (Datatypes.app _UU0394_1 ((:) (LntT.BBox b) ([])))
                  _UU0394_2) _evar_0_
                (Datatypes.app _UU0394_1
                  (Datatypes.app ((:) (LntT.BBox b) ([])) _UU0394_2)) __) d0
              x1 hprinc1) h0 d2 rl0 __) a hprinc0 x0 __) g d hprinc x rl __ __}}
...
principal_BBR_bac :: (([])
                     ...
                     LntT.Coq_dir)) -> (([]) (LntT.PropF a1)) -> (([])
                     (LntT.PropF a1)) -> (Coq_principal_BBR a1
                     (Lntkt_exchT.LNSKt_rules a1) ()) -> Coq_principal_BBox2Rs
                     a1 (Lntkt_exchT.LNSKt_rules a1) ()
              ...
              Logic.eq_rect_r
                ...
                (Datatypes.app g'
                  (Datatypes.app ((:) ((,) ((,) _UU03a3_0
                    ...
                    (Datatypes.app _UU0394_1
                      (Datatypes.app ((:) (LntT.BBox b) ([])) _UU0394_2)))
                    LntT.Coq_fwd) ([])))) __) d1 hprinc1 x1) h0 d2 rl0 __) a
          hprinc0 x0 __) g d hprinc x rl __ __};
   Coq_princ_BB2Rs x -> x}
