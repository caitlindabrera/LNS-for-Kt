   ...
   (,) p0 x0 ->
    case p0 of {
     (,) p1 x1 ->
      case p1 of {
       (,) lS1 lS2 ->
        Logic.eq_rect_r (Datatypes.app g1 ((:) ((,) seq1 d) ([])))
          (\d3 lS3 lS4 lS5 lS6 ->
          Logic.eq_rect_r ((,) _UU0393_
            (Datatypes.app _UU0394_1 (Datatypes.app ((:) a ([])) _UU0394_2)))
            (\d4 lS7 lS8 lS9 lS10 ->
            Logic.eq_rect_r (Datatypes.app g2 ((:) ((,) seq2 d) ([])))
              (\d5 lS11 lS12 lS13 lS14 ->
              Logic.eq_rect_r ((,)
                ...
                Logic.eq_rect
                  ...
                  (Logic.eq_rect
                    (Datatypes.app g3
                      (Datatypes.app ((:) ((,) ((,)
                        ...
                        (Datatypes.app _UU0394_1
                          (Datatypes.app _UU0394_2 _UU03a0_))) d) ([])) ([])))
                    (unsafeCoerce lS15 __ g1 _UU0393_ _UU0394_1 _UU0394_2 g2
                      _UU03a3_1 _UU03a3_2 _UU03a0_ ([]) g3 a d d4 d6 __ __ h3
                      x)
                    (Datatypes.app
                      (Datatypes.app g3 ((:) ((,) ((,)
                        (Datatypes.app _UU0393_
                  ...
                  (Datatypes.app g3 ((:) ((,) ((,)
                    (Datatypes.app _UU0393_
                      (Datatypes.app _UU03a3_1 _UU03a3_2))
                    (Datatypes.app _UU0394_1
                      (Datatypes.app _UU0394_2 _UU03a0_))) d) ([])))) seq2 d5
                lS14 lS13 lS12 lS11) ns2 d2 lS10 lS9 lS8 lS7) seq1 d3 lS6 lS5
            lS4 lS3) ns1 d1 lS1 lS2 x1 x0}}}

data Cut_rule v =
   Cut (([]) (LntT.PropF v)) (([]) (LntT.PropF v)) (([]) (LntT.PropF v)) 
...
data LNSKt_cut_rules v =
 ...
 (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF v))) LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules
                                                                    v)
 | LNSKt_rules_wc (([])
                  (([])
                  ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF v))) LntT.Coq_dir))) 
                   ...
                   (DdT.dersrecI_forall ps (\p hin ->
                     ...
                     case x2 of {
                      Specif.Coq_existT d2 _ ->
                       x (Dd_fc.derrec_height p d2) __ p d2 __}))) c) ps0 __
                 x0;
                                             ...
                                             Lnt_contraction_mrT.derrec_mergeL
                                               ...
                                               (coq_LNSKt_cut_admissibility
                                                 ...
                                                 (Datatypes.app _UU03a3_1
                                                   (Datatypes.app ((:) a ([]))
                                                     _UU03a3_2)) _UU03a0_) d1
                                                 _UU0393_ _UU0394_1 _UU0394_2
                                                 _UU03a3_1 _UU03a3_2 _UU03a0_
                                                 a hG3
                                                 (Structural_equivalence.struct_equiv_str_refl
                                                   g))}}}) c0 l2 h' __ h3 __
                                       x4) ps1 d0 l1 x3 __ __ h2) c0) ps1 __})
                             ps l0 d __ __ x2) concl l h0 __ __ x1) concl) ps
                       __ h1}) c) ps0 __ x0}) n1}
        in
