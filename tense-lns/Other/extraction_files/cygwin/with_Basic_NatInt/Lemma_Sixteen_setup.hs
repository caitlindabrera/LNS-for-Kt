...
type SR_wb_pre =
  ...
  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF Any))) LntT.Coq_dir))
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (DdT.Coq_derrec
  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF Any))) LntT.Coq_dir))
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (DdT.Coq_derrec
  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF Any))) LntT.Coq_dir))
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (Principal.Coq_principal_WBR Any
...
coq_SR_wb_fwd_bac :: ((,) Prelude.Int Prelude.Int) -> SR_wb -> (,) SR_wb_fwd
                     SR_wb_bac
...
coq_SR_wb_fwd_bac_rev :: ((,) Prelude.Int Prelude.Int) -> SR_wb_fwd ->
                         SR_wb_bac -> SR_wb
coq_SR_wb_fwd_bac_rev _ h1 h2 =
  unsafeCoerce
    ...
    case d of {
     LntT.Coq_fwd ->
      unsafeCoerce h1 __ g _UU0393_ _UU0394_1 _UU0394_2 h _UU03a3_1 _UU03a3_2
        _UU03a0_ i gH a d1 d2;
     LntT.Coq_bac ->
      unsafeCoerce h2 __ g _UU0393_ _UU0394_1 _UU0394_2 h _UU03a3_1 _UU03a3_2
        _UU03a0_ i gH a d1 d2})
...
type SR_bb_pre =
  ...
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (DdT.Coq_derrec
  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF Any))) LntT.Coq_dir))
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (Principal.Coq_principal_BBR Any
  (Lntkt_exchT.LNSKt_rules Any) ()) -> () ->
  (Structural_equivalence.Coq_struct_equiv_str Any) -> (Merge.Coq_merge 
  Any) -> () -> DdT.Coq_derrec
  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF Any))) LntT.Coq_dir))
...
coq_SR_bb_fwd_bac :: ((,) Prelude.Int Prelude.Int) -> SR_bb -> (,) SR_bb_fwd
                     SR_bb_bac
...
coq_SR_bb_fwd_bac_rev :: ((,) Prelude.Int Prelude.Int) -> SR_bb_fwd ->
                         SR_bb_bac -> SR_bb
...
type SR_p_pre =
  ...
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (DdT.Coq_derrec
  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF Any))) LntT.Coq_dir))
  (Lntkt_exchT.LNSKt_rules Any) ()) -> (Principal.Coq_principal_not_box_R 
