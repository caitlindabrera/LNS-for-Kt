         ...
         Logic.eq_rect_r (Datatypes.app l8 (Datatypes.Coq_cons c l7))
           (Logic.eq_rect_r a0 (\_ ->
             Logic.eq_rect_r (Datatypes.app l8 (Datatypes.Coq_cons c l7)) (\_ ->
               Datatypes.Coq_inr (Datatypes.Coq_inr l8)) l5 __) b0 __) l5) b0 __)}) __)
               ...
               case s of {
                Datatypes.Coq_inl _ ->
                 Logic.eq_rect_r l5 (\_ ->
                   Logic.eq_rect_r c (\_ ->
                     Logic.eq_rect_r l8 (\_ -> Datatypes.Coq_inr (Datatypes.Coq_inl __))
                       l6 __) b0 __) l9 __;
              ...
              Datatypes.Coq_inl _ ->
               Logic.eq_rect_r Datatypes.Coq_nil (\_ ->
                 Logic.eq_rect_r l7 (\_ _ ->
                   Logic.eq_rect_r b0 (\_ -> Datatypes.Coq_inl __) a1 __) l4 iHL1 __) l6
                 __;
               ...
               case h3 of {
                Specif.Coq_existT h4 _ ->
                 Logic.eq_rect_r
                   ...
                   __}}) a0 __) (Datatypes.app l7 (Datatypes.Coq_cons b0 l6))) a0 __)}) __)
    l1 l2 l3 a b __
   ...
   Datatypes.Coq_inr i ->
    (case i of {
      ...
      GenT.InT_cons b0 l x -> (\_ ->
       Logic.eq_rect_r b (\_ -> Logic.eq_rect_r l4 (\x0 -> Datatypes.Coq_inr x0) l) b0 __
         x)}) __}
    ...
    Datatypes.Coq_cons a y0 -> (\_ -> Datatypes.Coq_inl
     (Logic.eq_rect_r a (\_ ->
       Logic.eq_rect_r (Datatypes.app y0 z)
         (Logic.eq_rect_r a (\_ ->
           Logic.eq_rect_r (Datatypes.app y0 z) (\_ -> Specif.Coq_existT y0 __) x __) w
           __) x) w __))}) __
