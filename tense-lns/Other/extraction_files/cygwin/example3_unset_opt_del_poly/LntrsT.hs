...
gen_swapR_step_roe_lc :: (Datatypes.Coq_list
                         ...
                         (Datatypes.Coq_prod
                         (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
                         LntT.Coq_dir)) -> (LntT.Coq_rules_R_oeT (LntT.PropF a1) a2) -> a3
                         -> (DdT.Coq_dersrec
                         (Datatypes.Coq_list
                         (Datatypes.Coq_prod
                         (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
                       ...
                       Logic.eq_rect (List.map (LntT.nslcext g0 d0) ps0) (\acm0 ->
                         Logic.eq_rect_r
                           (Datatypes.app g1 (Datatypes.Coq_cons (Datatypes.Coq_pair
                             (Datatypes.Coq_pair seq1 seq2) d1) pp3)) (\acm1 ->
                           Logic.eq_rect_r
                             (Datatypes.app pp3 (Datatypes.Coq_cons (Datatypes.Coq_pair
                               (Datatypes.Coq_pair l l0) d0) Datatypes.Coq_nil))
                             (DdT.Coq_derI
                             (List.map
                               (LntT.nslcext
                                 (Datatypes.app g1 (Datatypes.Coq_cons (Datatypes.Coq_pair
                                   (Datatypes.Coq_pair _UU0393_0 _UU0394_') d1) pp3)) d0)
                               ps0)
                             (Datatypes.app g1 (Datatypes.Coq_cons (Datatypes.Coq_pair
                               (Datatypes.Coq_pair _UU0393_0 _UU0394_') d1)
                               (Datatypes.app pp3 (Datatypes.Coq_cons (Datatypes.Coq_pair
                                 (Datatypes.Coq_pair l l0) d0) Datatypes.Coq_nil))))
                             (unsafeCoerce rs0
                               (List.map
                               ...
                               (let {
                                ...
                                Logic.eq_rect_r
                                  (Datatypes.app (Datatypes.Coq_cons (Datatypes.Coq_pair
                                    (Datatypes.Coq_pair _UU0393_0 _UU0394_') d1) pp3)
                                    (Datatypes.Coq_cons (Datatypes.Coq_pair
                                    (Datatypes.Coq_pair l l0) d0) Datatypes.Coq_nil))
                                ...
                                let {
                                 qin0 = x __ __
                                          (LntT.nslcext
                                            (Datatypes.app g1 (Datatypes.Coq_cons
                                              (Datatypes.Coq_pair (Datatypes.Coq_pair
                                              _UU0393_0 _UU0394_') d1) pp3)) d0) ps0 q qin}
                                in
                                case qin0 of {
                                   ...
                                   Datatypes.Coq_pair _ x2 ->
                                    Logic.eq_rect
                                      (LntT.nslcext
                                        (Datatypes.app g1 (Datatypes.Coq_cons
                                          (Datatypes.Coq_pair (Datatypes.Coq_pair
                                          _UU0393_0 _UU0394_') d1) pp3)) d0 x0)
                                      (let {
                                        x3 = \_ _ l1 ->
                                        ...
                                        acm2 = x3 __ __
                                                 (List.map
                                                   (LntT.nslcext
                                                     (Datatypes.app g1 (Datatypes.Coq_cons
                                                       (Datatypes.Coq_pair
                                                       (Datatypes.Coq_pair seq1 seq2) d1)
                                                       pp3)) d0) ps0) acm1
                                                 (LntT.nslcext
                                                   (Datatypes.app g1 (Datatypes.Coq_cons
                                                     (Datatypes.Coq_pair
                                       ...
                                       let {
                                        acm3 = x4 __
                                                 ...
                                                 seq1 seq2) _UU0393_0 _UU0394_ _UU0394_'
                                                 d1 swap __ __}
                                       in
                                       let {
                                       ...
                                       Logic.eq_rect
                                         (Datatypes.app g1
                                           (Datatypes.app (Datatypes.Coq_cons
                                             (Datatypes.Coq_pair (Datatypes.Coq_pair
                                             _UU0393_0 _UU0394_') d1) pp3)
                                             (Datatypes.Coq_cons (Datatypes.Coq_pair x0
                                             d0) Datatypes.Coq_nil))) _evar_0_
                                         (Datatypes.app
                                           (Datatypes.app g1 (Datatypes.Coq_cons
                                             (Datatypes.Coq_pair (Datatypes.Coq_pair
                                             _UU0393_0 _UU0394_') d1) pp3))
                                           (Datatypes.Coq_cons (Datatypes.Coq_pair x0 d0)
                                           Datatypes.Coq_nil))) q}}))) k0) g0 acm0) ps acm};
                           ...
                           (Logic.eq_rect Datatypes.Coq_nil
                             (Logic.eq_rect_r _UU0393_0 (\_ ->
                               Logic.eq_rect_r _UU0394_ (\_ ->
                                 (case sppc1 of {
                                   Gen_seq.Sctxt ps1 c0 _UU03a6_1 _UU03a6_2 _UU03a8_1
                                    _UU03a8_2 pr -> (\_ _ ->
                                    Logic.eq_rect
                                      (List.map
                                        (Gen_seq.seqext _UU03a6_1 _UU03a6_2 _UU03a8_1
                                          _UU03a8_2) ps1) (\_ ->
                                      Logic.eq_rect
                                        (Gen_seq.seqext _UU03a6_1 _UU03a6_2 _UU03a8_1
                                          _UU03a8_2 c0) (\pr0 ->
                                        (case c0 of {
                                          Datatypes.Coq_pair l1 l2 -> (\pr1 _ ->
                                           Logic.eq_rect
                                             (List.map
                                               (Gen_seq.seqext _UU03a6_1 _UU03a6_2
                                                 _UU03a8_1 _UU03a8_2) ps1) (\acm1 _ ->
                                             Logic.eq_rect
                                               (Datatypes.app _UU03a6_1
                                                 (Datatypes.app l1 _UU03a6_2)) (\_ ->
                                               Logic.eq_rect
                                                 (Datatypes.app _UU03a8_1
                                                   (Datatypes.app l2 _UU03a8_2)) (\_ ->
                                                 (case swap of {
                                                   SwappedT.Coq_swapped_I x y a b c1 d2 ->
                                                    (\_ _ ->
                                                    Logic.eq_rect_r _UU0394_ (\_ ->
                                                      Logic.eq_rect_r _UU0394_' (\_ _ ->
                                                        Logic.eq_rect_r
                                                          (Datatypes.app a
                                                            (Datatypes.app b
                                                              (Datatypes.app c1 d2)))
                                                          ...
                                                          Logic.eq_rect_r
                                                            ...
                                                            (let {
                                                             ...
                                                             in
                                                             case pp3 of {
                                                              Specif.Coq_existT pp4 pp5 ->
                                                               case pp5 of {
                                                                Datatypes.Coq_inl _ ->
                                                                 let {
                                                                  pp6 = List_lemmasT.app_eq_appT2
                                                                          b
                                                                          (Datatypes.app
                                                                            c1 d2) pp4
                                                                          (Datatypes.app
                                                                     ...
                                                                     case pp9 of {
                                                                      Specif.Coq_existT pp10
                                                                       ...
                                                                       case pp11 of {
                                                                        Datatypes.Coq_inl _ ->
                                                                         let {
                                                                          pp12 = List_lemmasT.app_eq_appT2
                                                                                 c1 d2
                                                                                 pp10
                                                                                 _UU03a8_2}
                                                                         in
                                                                       ...
                                                                       (Logic.eq_rect_r
                                                                         ...
                                                                         (Logic.eq_rect_r
                                                                           ...
                                                                           (Logic.eq_rect_r
                                                                             ...
                                                                             acm1) pp4) a)
                                                                       _UU0393_0}}}})
                                                            _UU0394_') _UU0394_ __) y) x
                                                      __ __ __)}) __ __) l0 __) l __) ps0
                                             acm0 sppc1)}) pr0 __) (Datatypes.Coq_pair l
                                        l0)) ps0 __ pr)}) __ __) seq2 __) seq1 __) k0) g1)
                         ps acm;
                      Datatypes.Coq_inr pp3 ->
                       Logic.eq_rect (List.map (LntT.nslcext g0 d0) ps0) (\_ ->
                         Logic.eq_rect_r
                           (Datatypes.app g0 (Datatypes.Coq_cons (Datatypes.Coq_pair
                             (Datatypes.Coq_pair l l0) d0) pp3)) Logic.coq_False_rect g1)
                         ps acm}})}) pp0 __)}) sppc0 __ pp)) concl) ps __ sppc)}) __ __)
    __ nsr rs g k seq d _UU0394_1 _UU0394_2 _UU0394_3 _UU0394_4 _UU0393_ __ __
...
gen_swapR_step_pr_lc ps concl x x0 x1 x2 g k seq d _UU0394_1 _UU0394_2 _UU0394_3 _UU0394_4 _UU0393_ =
  gen_swapR_step_roe_lc ps concl LntT.princrule_pfc_R_oe'T x x0 x1 x2 g k seq d _UU0394_1
    _UU0394_2 _UU0394_3 _UU0394_4 _UU0393_
