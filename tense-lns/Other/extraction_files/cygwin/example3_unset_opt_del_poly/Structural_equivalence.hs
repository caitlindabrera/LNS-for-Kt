  ...
  Datatypes.list_rec Coq_se_nil2 (\a g0 iHG ->
    case a of {
     Datatypes.Coq_pair r x ->
      (case r of {
        Datatypes.Coq_pair _UU0393_ _UU0394_ -> (\d -> Coq_se_step2 _UU0393_ _UU0394_ d
         _UU0393_ _UU0394_ g0 g0 (Datatypes.Coq_cons (Datatypes.Coq_pair
         (Datatypes.Coq_pair _UU0393_ _UU0394_) d) g0) (Datatypes.Coq_cons
         (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_ _UU0394_) d) g0) iHG)}) x}) g
    ...
    (case hs of {
      ...
      Coq_se_step2 _ _ _ _ _ _ _ ns3 ns4 h1 -> (\_ _ ->
       Logic.eq_rec_r Datatypes.Coq_nil (\_ ->
         Logic.eq_rec_r b (\_ _ _ -> Logic.coq_False_rec) ns4) ns3 __ __ __ h1)}) __ __)
    (\a0 a1 iHA b hs ->
    (case hs of {
                           ...
                           Logic.eq_rec (Datatypes.app a3 a4)
                             (Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair
                               ...
                               Logic.eq_rec (Datatypes.app a3 a4) (\_ h5 ->
                                 ...
                                 ns1 __ h4) a hs1 __) ns1) a __) ns2 __ h3) p hs0 __) ns2)
                   p __) ns4) ns3 __ __ __ h2)}) __ __) (Datatypes.length b5))}) __ hs) a1
    a2 b1 b2 __ x
  ...
  Datatypes.list_rect (\h2 a1 a2 b1 b2 d hstr ->
    (case hstr of {
      ...
      Coq_se_step2 _ _ _ _ _ _ _ ns3 ns4 h3 -> (\_ _ ->
       Logic.eq_rec_r Datatypes.Coq_nil (\_ ->
         Logic.eq_rec_r h2 (\_ _ _ -> Logic.coq_False_rec) ns4) ns3 __ __ __ h3)}) __ __)
             ...
             Logic.eq_rec_r ns1
               (Logic.eq_rec_r (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
                 ...
                 Logic.eq_rec_r (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_1
                   ...
                   Logic.eq_rect_r ns1 (\iHlist0 _ _ -> Coq_se_step2 _UU0393_1 _UU0394_1
                     d0 _UU0393_2 _UU0394_2
                 ...
                 hstr __) h2) a __) ns4) ns3 __ __ __ h4)}) __ __) h1
