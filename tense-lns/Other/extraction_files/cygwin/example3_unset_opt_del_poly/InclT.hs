...
inclT_consL_InT :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1 -> (Coq_inclT
                   a1) -> GenT.InT a1
...
inclT_appL :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list
              a1) -> (Coq_inclT a1) -> (Coq_inclT a1) -> Coq_inclT a1
...
inclT_appRL :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list
               a1) -> (Coq_inclT a1) -> Coq_inclT a1
