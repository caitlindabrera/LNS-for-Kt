...
trans_co_eq_inv_arrow_morphism_obligation_1 :: (CRelationClasses.Transitive a1 a2) -> a1
                                               -> a1 -> a2 -> a1 -> a1 ->
...
trans_co_eq_inv_arrow_morphism :: (CRelationClasses.Transitive a1 a2) -> a1 -> a1 -> a2 ->
