...
type SR_wb_pre =
  ...
  (LntT.PropF Any)) -> (Datatypes.Coq_list (LntT.PropF Any)) ->
  ...
  (Datatypes.Coq_prod
  (Datatypes.Coq_prod (Datatypes.Coq_list (LntT.PropF Any))
  (Datatypes.Coq_list (LntT.PropF Any))) LntT.Coq_dir)) -> (LntT.PropF 
  Any) -> LntT.Coq_dir -> (DdT.Coq_derrec
  (Datatypes.Coq_list
   ...
   Datatypes.Coq_pair _ _ -> (\h -> Datatypes.Coq_pair
    (unsafeCoerce
      ...
      unsafeCoerce h __ g _UU0393_ _UU0394_1 _UU0394_2 h0 _UU03a3_1 _UU03a3_2
        _UU03a0_ i gH a LntT.Coq_fwd d1 d2))
    (unsafeCoerce
      (\_ g _UU0393_ _UU0394_1 _UU0394_2 h0 _UU03a3_1 _UU03a3_2 _UU03a0_ i gH a d1 d2 ->
      unsafeCoerce h __ g _UU0393_ _UU0394_1 _UU0394_2 h0 _UU03a3_1 _UU03a3_2
        _UU03a0_ i gH a LntT.Coq_bac d1 d2)))}

coq_SR_wb_fwd_bac_rev :: (Datatypes.Coq_prod Datatypes.Coq_nat
                         Datatypes.Coq_nat) -> SR_wb_fwd -> SR_wb_bac -> SR_wb
...
coq_SR_bb_fwd_bac_rev :: (Datatypes.Coq_prod Datatypes.Coq_nat
                         Datatypes.Coq_nat) -> SR_bb_fwd -> SR_bb_bac -> SR_bb
...
type SR_p_pre =
  ...
  (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF Any)))
  LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules Any) ()) ->
  (Principal.Coq_principal_not_box_R Any) -> () -> () -> (Size.Coq_not_box
  Any) -> (Structural_equivalence.Coq_struct_equiv_str Any) ->
  (Merge.Coq_merge Any) -> DdT.Coq_derrec
  (Datatypes.Coq_list
  (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF Any)))
  LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules Any) ()
