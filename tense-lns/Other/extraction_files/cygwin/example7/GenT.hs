         ...
         Logic.eq_rect_r (Datatypes.Coq_cons y Datatypes.Coq_nil) (\x4 x5 ->
           (case x5 of {
             ...
             ForallT_cons x6 l0 x7 x8 -> (\_ ->
              Logic.eq_rect_r y (\_ ->
                Logic.eq_rect_r Datatypes.Coq_nil (\x9 _ -> Datatypes.Coq_pair
                  x4 x9) l0) x6 __ x7 x8)}) __) l) x1 __ x2 x3)}) __) (\x0 ->
    case x0 of {
...
coq_InT_appL :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                (InT a1) -> InT a1
...
coq_InT_appR :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                (InT a1) -> InT a1
...
coq_InT_appE' a z x x0 y =
  coq_InT_rect a (\b l _ x1 y0 _ ->
    ...
    (case x2 of {
      Datatypes.Coq_nil -> (\_ ->
       Logic.eq_rect (Datatypes.Coq_cons b l) (Datatypes.Coq_inr (InT_cons b l
         x1)) y0);
...
coq_InT_appE :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                (InT a1) -> Datatypes.Coq_sum (InT a1) (InT a1)
         ...
         Logic.eq_rect_r a (\_ ->
           Logic.eq_rect_r l0 (\x5 x6 ->
             (case x1 of {
               ...
               InT_cons b l2 x7 -> (\_ ->
                Logic.eq_rect_r a (\_ ->
                  Logic.eq_rect_r l0 (\x8 -> p x6 x0 x8) l2) b __ x7)}) __) l1)
           x2 __ x3 x4)}) __}) (\x ->
    case iHl of {
