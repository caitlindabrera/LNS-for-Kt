...
coq_SR_wb_base :: Datatypes.Coq_nat -> (Datatypes.Coq_list
                  ...
                  (Datatypes.Coq_prod
                  (Datatypes.Coq_prod (Datatypes.Coq_list (LntT.PropF a1))
                  (Datatypes.Coq_list (LntT.PropF a1))) LntT.Coq_dir)) -> (LntT.PropF a1) ->
                  ...
                  (Datatypes.Coq_list
                  (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
                  LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules a1) ()) -> (Principal.Coq_principal_WBR 
                  a1 (Lntkt_exchT.LNSKt_rules a1) ()) -> (Structural_equivalence.Coq_struct_equiv_str
...
coq_SR_bb_base :: Datatypes.Coq_nat -> (Datatypes.Coq_list
                  ...
                  (Datatypes.Coq_list
                  (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
                  LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules a1) ()) -> (Principal.Coq_principal_BBR 
                  a1 (Lntkt_exchT.LNSKt_rules a1) ()) -> (Structural_equivalence.Coq_struct_equiv_str
                  a1) -> (Merge.Coq_merge a1) -> DdT.Coq_derrec
                  (Datatypes.Coq_list
                  (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
...
coq_SR_p_base :: Datatypes.Coq_nat -> (Datatypes.Coq_list
                 ...
                 (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
                 LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules a1) ()) ->
                 (Principal.Coq_principal_not_box_R a1) -> (Size.Coq_not_box a1) ->
                 (Structural_equivalence.Coq_struct_equiv_str a1) -> (Merge.Coq_merge a1) ->
                 DdT.Coq_derrec
                 (Datatypes.Coq_list
                 (Datatypes.Coq_prod (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1)))
                 LntT.Coq_dir)) (Lntkt_exchT.LNSKt_rules a1) ()
...
coq_Lemma_Sixteen_base_case :: Datatypes.Coq_nat -> Datatypes.Coq_prod
                               ...
                               Lemma_Sixteen_setup.SR_bb_pre) Lemma_Sixteen_setup.SR_p_pre)
...
coq_Lemma_Sixteen :: (Datatypes.Coq_prod Datatypes.Coq_nat Datatypes.Coq_nat) -> Datatypes.Coq_prod
                     (Datatypes.Coq_prod
                     (Datatypes.Coq_prod Lemma_Sixteen_setup.SR_wb Lemma_Sixteen_setup.SR_bb)
         ...
         Datatypes.S n0 -> (\x1 ->
          let {
           hSRwb = \_ x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 _ x18 x19 _ ->
            Lemma_Sixteen_SR_wb.coq_Lemma_Sixteen_SR_wb n0 m x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12
              x13 x14 x15 x16 x17 x18 x19}
          in
          let {
           hSRbb = \_ x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 _ x18 x19 _ ->
            Lemma_Sixteen_SR_bb.coq_Lemma_Sixteen_SR_bb n0 m x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12
              x13 x14 x15 x16 x17 x18 x19}
          in
          let {
           hSRp = \_ x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 _ _ ->
            Lemma_Sixteen_SR_p.coq_Lemma_Sixteen_SR_p n0 m hSRwb hSRbb x1 x2 x3 x4 x5 x6 x7 x8 x9 x10
              x11 x12 x13 x14 x15 x16}
          in
          let {
           hSL = \_ x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 _ _ ->
            Lemma_Sixteen_SL.coq_Lemma_Sixteen_SL n0 m hSRwb hSRbb hSRp x1 x2 x3 x4 x5 x6 x7 x8 x9
              x10 x11 x12 x13 x14 x15}
          in
          Datatypes.Coq_pair (Datatypes.Coq_pair (Datatypes.Coq_pair (unsafeCoerce hSRwb)
          (unsafeCoerce hSRbb)) (unsafeCoerce hSRp)) (unsafeCoerce hSL))}) x0)}) x) nm
