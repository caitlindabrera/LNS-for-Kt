...
coq_LNSKt_cut_admissibility :: (Datatypes.Coq_list
                               ...
                               (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1))) LntT.Coq_dir))
                               -> (Datatypes.Coq_prod (Datatypes.Coq_list (LntT.PropF a1))
                               (Datatypes.Coq_list (LntT.PropF a1))) -> (Datatypes.Coq_prod
                               ...
                               (Structural_equivalence.Coq_struct_equiv_str a1) -> DdT.Coq_derrec
                               (Datatypes.Coq_list
                               (Datatypes.Coq_prod
                               (Gen_tacs.Coq_rel (Datatypes.Coq_list (LntT.PropF a1))) LntT.Coq_dir))
      ...
      Datatypes.Coq_pair p1 x1 ->
       (case p1 of {
         Datatypes.Coq_pair lS1 lS2 -> (\lS3 lS4 ->
          Logic.eq_rect_r
            (Datatypes.app g1 (Datatypes.Coq_cons (Datatypes.Coq_pair seq1 d) Datatypes.Coq_nil))
            (\d3 lS5 lS6 lS7 lS8 ->
            Logic.eq_rect_r (Datatypes.Coq_pair _UU0393_
              ...
              Logic.eq_rect_r
                (Datatypes.app g2 (Datatypes.Coq_cons (Datatypes.Coq_pair seq2 d) Datatypes.Coq_nil))
                (\d5 lS13 lS14 lS15 lS16 ->
                Logic.eq_rect_r (Datatypes.Coq_pair
                  (Datatypes.app _UU03a3_1
                    (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil) _UU03a3_2)) _UU03a0_)
                  (\d6 lS17 _ _ _ ->
                  Logic.eq_rect
                    (Datatypes.app
                      (Datatypes.app g3 (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
                    ...
                    (Logic.eq_rect
                      (Datatypes.app g3
                        (Datatypes.app (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
                          ...
                          (Datatypes.app _UU0394_1 (Datatypes.app _UU0394_2 _UU03a0_))) d)
                          Datatypes.Coq_nil) Datatypes.Coq_nil))
                      (unsafeCoerce lS17 __ g1 _UU0393_ _UU0394_1 _UU0394_2 g2 _UU03a3_1 _UU03a3_2
                        _UU03a0_ Datatypes.Coq_nil g3 a d d4 d6 __ __ h3 x)
                      (Datatypes.app
                        (Datatypes.app g3 (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
                          (Datatypes.app _UU0393_ (Datatypes.app _UU03a3_1 _UU03a3_2))
                          (Datatypes.app _UU0394_1 (Datatypes.app _UU0394_2 _UU03a0_))) d)
                    ...
                    (Datatypes.app g3 (Datatypes.Coq_cons (Datatypes.Coq_pair (Datatypes.Coq_pair
                      (Datatypes.app _UU0393_ (Datatypes.app _UU03a3_1 _UU03a3_2))
                      (Datatypes.app _UU0394_1 (Datatypes.app _UU0394_2 _UU03a0_))) d)
                      Datatypes.Coq_nil))) seq2 d5 lS16 lS15 lS14 lS13) ns2 d2 lS12 lS11 lS10 lS9)
              seq1 d3 lS8 lS7 lS6 lS5) ns1 d1 lS1 lS2 lS3 lS4)}) x1}) x0}
                  ...
                  Logic.eq_rect_r ps (\_ ->
                    Logic.eq_rect_r concl (\x2 -> DdT.Coq_derI ps concl x2
                      (DdT.dersrecI_forall ps (\p hin ->
                        ...
                        case x3 of {
                         Specif.Coq_existT d2 _ -> x0 (Dd_fc.derrec_height p d2) __ p d2 __}))) c)
                    ps0 __ x1);
                           ...
                           Logic.eq_rect (LntT.nslclext g c0) (\x4 ->
                             Logic.eq_rect (LntT.nslclext g c0) (\l0 h'0 _ _ x5 ->
                               Logic.eq_rect (List.map (LntT.nslclext g) ps1) (\l1 d0 _ _ x6 ->
                                 (case x4 of {
                                   Cut _UU0393_ _UU0394_1 _UU0394_2 _UU03a3_1 _UU03a3_2 _UU03a0_ d1
                                    a -> (\_ _ ->
                                    Logic.eq_rect
                                      (Datatypes.app (Datatypes.Coq_cons (Datatypes.Coq_cons
                                        (Datatypes.Coq_pair (Datatypes.Coq_pair _UU0393_
                                        (Datatypes.app _UU0394_1
                                          (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil)
                                            _UU0394_2))) d1) Datatypes.Coq_nil) Datatypes.Coq_nil)
                                        (Datatypes.Coq_cons (Datatypes.Coq_cons (Datatypes.Coq_pair
                                        (Datatypes.Coq_pair
                                        (Datatypes.app _UU03a3_1
                                          (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil)
                                            _UU03a3_2)) _UU03a0_) d1) Datatypes.Coq_nil)
                                        Datatypes.Coq_nil)) (\_ ->
                                      Logic.eq_rect (Datatypes.Coq_cons (Datatypes.Coq_pair
                                        ...
                                        (Logic.eq_rect
                                          (Datatypes.app (Datatypes.Coq_cons (Datatypes.Coq_cons
                                            ...
                                            (Datatypes.app _UU0394_1
                                              (Datatypes.app (Datatypes.Coq_cons a Datatypes.Coq_nil)
                                                _UU0394_2))) d1) Datatypes.Coq_nil)
                                                  ...
                                                  case s0 of {
                                                   Specif.Coq_existT g3 hG3 ->
                                                    Lnt_contraction_mrT.derrec_mergeL g
                                                      ...
                                                      (Datatypes.app _UU0394_1
                                                        (Datatypes.app _UU0394_2 _UU03a0_))) d1)
                                                      Datatypes.Coq_nil) g3 hG3
                                                      (coq_LNSKt_cut_admissibility
                                                        (Datatypes.app g (Datatypes.Coq_cons
                                                          (Datatypes.Coq_pair (Datatypes.Coq_pair
                                                          _UU0393_
                                                          (Datatypes.app _UU0394_1
                                                            (Datatypes.app (Datatypes.Coq_cons a
                                                          ...
                                                          (Dd_fc.derrec_height
                                                            (Datatypes.app g (Datatypes.Coq_cons
                                                              ...
                                                              (Datatypes.app _UU03a3_1
                                                                (Datatypes.app (Datatypes.Coq_cons a
                                                                  Datatypes.Coq_nil) _UU03a3_2))
                                                              _UU03a0_) d1) Datatypes.Coq_nil)) d4)
                                                          __
                                                          (Datatypes.app g (Datatypes.Coq_cons
                                                            (Datatypes.Coq_pair (Datatypes.Coq_pair
                                                            (Datatypes.app _UU03a3_1
                                                              (Datatypes.app (Datatypes.Coq_cons a
                                                                Datatypes.Coq_nil) _UU03a3_2))
                                                            _UU03a0_) d1) Datatypes.Coq_nil)) d4 __)
                                                        g g g3 (Datatypes.Coq_pair _UU0393_
                                                        (Datatypes.app _UU0394_1
                                                          (Datatypes.app (Datatypes.Coq_cons a
                                                        ...
                                                        (Datatypes.app _UU03a3_1
                                                          (Datatypes.app (Datatypes.Coq_cons a
                                                            Datatypes.Coq_nil) _UU03a3_2)) _UU03a0_)
                                                        d1 _UU0393_ _UU0394_1 _UU0394_2 _UU03a3_1
                                                        _UU03a3_2 _UU03a0_ a hG3
                                                        (Structural_equivalence.struct_equiv_str_refl
                                                          g))}}}}) c0 l2 h'0 __ x8 __ x7) ps1 d0 l1
                                          x6 __ __ x4) c0) ps1 __)}) __ __) ps l0 d __ __ x5) concl l
                               h' __ __ x2) concl) ps __ x3)}) __ __) c) ps0 __ x1)}) __ __) n1}
          in
