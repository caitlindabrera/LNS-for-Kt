  ...
  Datatypes.Coq_pair (\x0 ->
    (case x0 of {
      ...
      ForallT_cons x1 l x2 x3 -> (\_ ->
       Logic.eq_rect_r x (\_ -> Logic.eq_rect_r Datatypes.Coq_nil (\x4 _ -> x4) l) x1 __ x2 x3)}) __)
         ...
         Logic.eq_rect_r (Datatypes.Coq_cons y Datatypes.Coq_nil) (\x4 x5 ->
           (case x5 of {
             ...
             ForallT_cons x6 l0 x7 x8 -> (\_ ->
              Logic.eq_rect_r y (\_ ->
                Logic.eq_rect_r Datatypes.Coq_nil (\x9 _ -> Datatypes.Coq_pair x4 x9) l0) x6 __ x7 x8)})
             __) l) x1 __ x2 x3)}) __) (\x0 ->
    case x0 of {
...
coq_InT_rect :: a1 -> (a1 -> (Datatypes.Coq_list a1) -> () -> a2) -> (a1 -> (Datatypes.Coq_list 
                a1) -> (InT a1) -> a2 -> a2) -> (Datatypes.Coq_list a1) -> (InT a1) -> a2
coq_InT_rect _ f f0 =
  let {
   f1 _ i =
     case i of {
...
coq_InT_appL a x y x0 =
  coq_InT_rect a (\b l _ -> Logic.eq_rect_r a (coq_InT_eq a (Datatypes.app l y)) b) (\b l _ iHX0 ->
...
coq_InT_appE' :: a1 -> (Datatypes.Coq_list a1) -> (InT a1) -> (Datatypes.Coq_list a1) ->
                 (Datatypes.Coq_list a1) -> Datatypes.Coq_sum (InT a1) (InT a1)
coq_InT_appE' a z x x0 y =
  coq_InT_rect a (\b l _ x1 y0 _ ->
    (case x1 of {
      Datatypes.Coq_nil -> (\_ ->
       Logic.eq_rect_r a (\_ ->
         Logic.eq_rect (Datatypes.Coq_cons a l) (Datatypes.Coq_inr (coq_InT_eq a l)) y0) b __);
      Datatypes.Coq_cons a0 x2 -> (\_ ->
       Logic.eq_rect_r a (\_ _ ->
         Logic.eq_rect_r (Datatypes.app x2 y0) (\_ ->
           Logic.eq_rect_r a0 (\_ -> Datatypes.Coq_inl (coq_InT_eq a0 x2)) a __) l __) b __ __)}) __)
    (\b l x1 iHX x2 y0 _ ->
    (case x2 of {
      Datatypes.Coq_nil -> (\_ ->
...
coq_InT_split :: a1 -> (Datatypes.Coq_list a1) -> (InT a1) -> Specif.Coq_sigT (Datatypes.Coq_list a1)
                 (Specif.Coq_sigT (Datatypes.Coq_list a1) ())
coq_InT_split x l x0 =
  coq_InT_rect x (\_ l0 _ -> Specif.Coq_existT Datatypes.Coq_nil (Specif.Coq_existT l0 __))
    (\b l0 x1 iHX ->
    case iHX of {
     Specif.Coq_existT x2 s ->
      case s of {
       Specif.Coq_existT x3 _ ->
        Logic.eq_rect_r (Datatypes.app x2 (Datatypes.Coq_cons x x3)) (\_ -> Specif.Coq_existT
          (Datatypes.Coq_cons b x2) (Specif.Coq_existT x3 __)) l0 x1}}) l x0

coq_InT_map :: (a1 -> a2) -> (Datatypes.Coq_list a1) -> a1 -> (InT a1) -> InT a2
coq_InT_map f l x x0 =
  coq_InT_rect x (\b l0 _ -> Logic.eq_rect_r x (coq_InT_eq (f x) (List.map f l0)) b) (\b l0 _ iHX ->
    InT_cons (f b) (List.map f l0) iHX) l x0

coq_InT_mapE :: (a1 -> a2) -> (Datatypes.Coq_list a1) -> a2 -> (InT a2) -> Specif.Coq_sigT a1
                (Datatypes.Coq_prod () (InT a1))
            ...
            Specif.Coq_existT x4 x5 ->
             case x5 of {
              Datatypes.Coq_pair _ x6 -> Specif.Coq_existT x4
               (Logic.eq_rect (f x4) (\_ _ -> Datatypes.Coq_pair __ (InT_cons a l0 x6)) y x0 iHl)}})
           l1) b __ x1)}) __) l x

coq_InT_map_iffT :: (a1 -> a2) -> (Datatypes.Coq_list a1) -> a2 -> CRelationClasses.Coq_iffT 
                    (InT a2) (Specif.Coq_sigT a1 (Datatypes.Coq_prod () (InT a1)))
...
coq_ForallT_forall l =
  Datatypes.list_rect (Datatypes.Coq_pair (\_ -> coq_InT_nilE) (\_ -> ForallT_nil)) (\a l0 iHl ->
    Datatypes.Coq_pair (\x x0 x1 ->
    case iHl of {
         ...
         Logic.eq_rect_r a (\_ ->
           Logic.eq_rect_r l0 (\x5 x6 ->
             (case x1 of {
               InT_eq' b l2 -> (\_ ->
                Logic.eq_rect_r a (\_ ->
                  Logic.eq_rect_r l0 (\_ -> Logic.eq_rect_r x0 (\_ _ x7 _ -> x7) a x x1 x5 __) l2) b
                  __ __);
               InT_cons b l2 x7 -> (\_ ->
                Logic.eq_rect_r a (\_ -> Logic.eq_rect_r l0 (\x8 -> p x6 x0 x8) l2) b __ x7)}) __) l1)
           x2 __ x3 x4)}) __}) (\x ->
    case iHl of {
...
want_prod_under_universal4 x =
  Datatypes.Coq_pair (Datatypes.Coq_pair (Datatypes.Coq_pair (\y x0 ->
    ...
    let {x2 = x1 x0} in
    Datatypes.prod_rect (\a _ ->
      Datatypes.prod_rect (\a0 _ -> Datatypes.prod_rect (\_ b1 -> b1) a0) a) x2)) (\y x0 ->
    let {x1 = x y} in
    let {x2 = x1 x0} in Datatypes.prod_rect (\a _ -> Datatypes.prod_rect (\_ b0 -> b0) a) x2))
    (\y x0 -> let {x1 = x y} in let {x2 = x1 x0} in Datatypes.prod_rect (\_ b -> b) x2)
