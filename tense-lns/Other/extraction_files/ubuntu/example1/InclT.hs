...
inclT_consL_InT :: (([]) a1) -> (([]) a1) -> a1 -> (Coq_inclT a1) -> GenT.InT a1
inclT_consL_InT l1 _ a hincl =
  hincl a (GenT.InT_eq' a l1)

inclT_consL_inclT :: (([]) a1) -> (([]) a1) -> a1 -> (Coq_inclT a1) -> Coq_inclT a1
inclT_consL_inclT l1 _ a hincl b hin =
  hincl b (GenT.InT_cons a l1 hin)

inclT_appL :: (([]) a1) -> (([]) a1) -> (([]) a1) -> (Coq_inclT a1) -> (Coq_inclT a1) -> Coq_inclT a1
...
inclT_appRL :: (([]) a1) -> (([]) a1) -> (([]) a1) -> (Coq_inclT a1) -> Coq_inclT a1
