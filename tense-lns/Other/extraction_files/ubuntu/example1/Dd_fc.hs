...
data Coq_in_dersrec x rules prems =
 ...
 | Coq_in_dersrec_tl x (DdT.Coq_derrec x rules prems) (([]) x) (DdT.Coq_dersrec x rules prems) 
...
dersrec_height _ ders =
  case ders of {
   DdT.Coq_dlNil -> 0;
   DdT.Coq_dlCons seq seqs d ds -> Prelude.max (derrec_height seq d) (dersrec_height seqs ds)}

dersrecD_forall_in_dersrec :: (([]) a1) -> (DdT.Coq_dersrec a1 a2 a3) -> a1 -> (GenT.InT a1) ->
                              Specif.Coq_sigT (DdT.Coq_derrec a1 a2 a3) (Coq_in_dersrec a1 a2 a3)
...
dersrec_double_verb :: a1 -> a1 -> (DdT.Coq_dersrec a1 a2 a3) -> Specif.Coq_sigT
                       ...
                       ((,) (Coq_in_dersrec a1 a2 a3) (Coq_in_dersrec a1 a2 a3)))
dersrec_double_verb c1 c2 d =
  ...
  case hin3 of {
   Specif.Coq_existT d1 hin4 -> Specif.Coq_existT d1
    (let {hin5 = dersrecD_forall_in_dersrec ((:) c1 ((:) c2 ([]))) d c2 hin2} in
     case hin5 of {
...
dersrec_derrec_height :: Prelude.Int -> a1 -> (DdT.Coq_dersrec a1 a2 a3) -> Specif.Coq_sigT
                         (DdT.Coq_derrec a1 a2 a3) ()
  ...
  case d2 of {
   ...
   DdT.Coq_dlCons seq seqs d d3 ->
    Logic.eq_rect_r (DdT.Coq_dlCons seq seqs d d3) (\_ ->
      Logic.eq_rect (dersrec_height ((:) seq seqs) (DdT.Coq_dlCons seq seqs d d3))
        (Logic.eq_rect_r g (\_ d0 ->
          Logic.eq_rect_r ([]) (\_ _ -> Specif.Coq_existT d0 __) seqs __ d3) seq __ d) n) d2 __}

dersrec_derrec2_height :: Prelude.Int -> a1 -> a1 -> (DdT.Coq_dersrec a1 a2 a3) -> Specif.Coq_sigT
   ...
   DdT.Coq_dlCons seq seqs d d3 ->
    case seqs of {
     ...
     (:) x seqs0 ->
      case seqs0 of {
       ([]) ->
        let {s = dersrec_derrec_height (dersrec_height ((:) x ([])) d3) x d3} in
        case s of {
         Specif.Coq_existT x0 _ ->
          Logic.eq_rect_r (DdT.Coq_dlCons seq ((:) x ([])) d d3) (\_ ->
            Logic.eq_rect
              (dersrec_height ((:) seq ((:) x ([]))) (DdT.Coq_dlCons seq ((:) x ([])) d d3))
              (Logic.eq_rect_r g1 (\_ d0 ->
                Logic.eq_rect_r g2 (\_ _ x1 _ -> Specif.Coq_existT d0 (Specif.Coq_existT x1 __)) x __
                  d3 x0 __) seq __ d) n) d2 __};
       (:) _ _ -> Logic.coq_False_rect}}}

dersrec_derrec_dp :: Prelude.Int -> a1 -> (DdT.Coq_dersrec a1 a2 a3) -> Specif.Coq_sigT
                     (DdT.Coq_derrec a1 a2 a3) ()
dersrec_derrec_dp =
  dersrec_derrec_height

dersrec_derrec2_dp :: Prelude.Int -> a1 -> a1 -> (DdT.Coq_dersrec a1 a2 a3) -> Specif.Coq_sigT
                      (DdT.Coq_derrec a1 a2 a3) (Specif.Coq_sigT (DdT.Coq_derrec a1 a2 a3) ())
dersrec_derrec2_dp =
