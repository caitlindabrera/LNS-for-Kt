...
coq_SR_wb_base :: Prelude.Int -> (([])
                  ...
                  (Lntkt_exchT.LNSKt_rules a1) ()) -> (DdT.Coq_derrec
                  (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1))) LntT.Coq_dir))
                  (Lntkt_exchT.LNSKt_rules a1) ()) -> (Principal.Coq_principal_WBR a1
                  (Lntkt_exchT.LNSKt_rules a1) ()) -> (Structural_equivalence.Coq_struct_equiv_str
...
coq_SR_p_base :: Prelude.Int -> (([])
                 ...
                 (LntT.PropF a1)) -> (([]) (LntT.PropF a1)) -> (([]) (LntT.PropF a1)) -> (([])
                 ((,) ((,) (([]) (LntT.PropF a1)) (([]) (LntT.PropF a1))) LntT.Coq_dir)) -> (([])
                 ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1))) LntT.Coq_dir)) -> (LntT.PropF 
                 a1) -> LntT.Coq_dir -> (DdT.Coq_derrec
                 (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1))) LntT.Coq_dir))
                 (Lntkt_exchT.LNSKt_rules a1) ()) -> (DdT.Coq_derrec
                 (([]) ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1))) LntT.Coq_dir))
                 (Lntkt_exchT.LNSKt_rules a1) ()) -> (Principal.Coq_principal_not_box_R a1) ->
                 (Size.Coq_not_box a1) -> (Structural_equivalence.Coq_struct_equiv_str a1) ->
...
coq_SL_base :: Prelude.Int -> (([])
               ...
               (LntT.PropF a1)) -> (([]) (LntT.PropF a1)) -> (([]) (LntT.PropF a1)) -> (([])
               ((,) ((,) (([]) (LntT.PropF a1)) (([]) (LntT.PropF a1))) LntT.Coq_dir)) -> (([])
               ((,) (Gen_tacs.Coq_rel (([]) (LntT.PropF a1))) LntT.Coq_dir)) -> (LntT.PropF a1) ->
...
coq_Lemma_Sixteen_base_case :: Prelude.Int -> (,)
                               ((,) ((,) Lemma_Sixteen_setup.SR_wb_pre Lemma_Sixteen_setup.SR_bb_pre)
      ...
      (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
        ...
        let {
         hSRwb = \x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 ->
          Lemma_Sixteen_SR_wb.coq_Lemma_Sixteen_SR_wb n0 m x x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11
            x12 x13 x14 x15 x16 x17}
        in
        let {
         hSRbb = \x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 ->
          Lemma_Sixteen_SR_bb.coq_Lemma_Sixteen_SR_bb n0 m x x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11
            x12 x13 x14 x15 x16 x17}
        in
        let {
         hSRp = \x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 ->
          Lemma_Sixteen_SR_p.coq_Lemma_Sixteen_SR_p n0 m
            ...
            (\_ x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 _ x31 x32 _ ->
            hSRbb x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 x31 x32) x x0 x1 x2
        ...
        let {
         hSL = \x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 ->
          Lemma_Sixteen_SL.coq_Lemma_Sixteen_SL n0 m
            ...
            hSRp x14 x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28) x x0 x1 x2 x3 x4 x5 x6
