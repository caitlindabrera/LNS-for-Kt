...
type Coq_can_gen_swapL v rules =
  ...
  (([]) (LntT.PropF v))) -> LntT.Coq_dir -> (([]) (LntT.PropF v)) -> (([]) (LntT.PropF v)) -> (([])
  (LntT.PropF v)) -> (([]) (LntT.PropF v)) -> (([]) (LntT.PropF v)) -> () -> () -> DdT.Coq_derrec
...
can_gen_swapL_def' :: (([]) ((,) ((,) (([]) (LntT.PropF a1)) (([]) (LntT.PropF a1))) LntT.Coq_dir))
      ...
      Logic.eq_rect_r (Datatypes.app a (Datatypes.app b (Datatypes.app c d0))) (\_ ->
        Logic.eq_rect_r (Datatypes.app a (Datatypes.app c (Datatypes.app b d0)))
          (Logic.eq_rect_r (Datatypes.app g ((:) ((,) seq d) k)) (\x1 ->
            Logic.eq_rect_r ((,) (Datatypes.app a (Datatypes.app b (Datatypes.app c d0))) _UU0394_)
              (\x2 ->
              x2 g k ((,) (Datatypes.app a (Datatypes.app b (Datatypes.app c d0))) _UU0394_) d a b c
...
can_gen_swapR_def' :: (([]) ((,) ((,) (([]) (LntT.PropF a1)) (([]) (LntT.PropF a1))) LntT.Coq_dir))
    ...
    case h of {
     SwappedT.Coq_swapped_I x0 y a b c d0 ->
      Logic.eq_rect_r (Datatypes.app a (Datatypes.app b (Datatypes.app c d0))) (\_ ->
        Logic.eq_rect_r (Datatypes.app a (Datatypes.app c (Datatypes.app b d0)))
          (Logic.eq_rect_r (Datatypes.app g ((:) ((,) seq d) k)) (\x1 ->
            Logic.eq_rect_r ((,) _UU0393_ (Datatypes.app a (Datatypes.app b (Datatypes.app c d0))))
              (\x2 ->
              x2 g k ((,) _UU0393_ (Datatypes.app a (Datatypes.app b (Datatypes.app c d0)))) d a b c
                d0 _UU0393_ __ __) seq x1) ns x) y) x0 __})
...
can_gen_swapL_imp :: (([]) ((,) ((,) (([]) (LntT.PropF a1)) (([]) (LntT.PropF a1))) LntT.Coq_dir)) ->
...
can_gen_swapR_imp :: (([]) ((,) ((,) (([]) (LntT.PropF a1)) (([]) (LntT.PropF a1))) LntT.Coq_dir)) ->
...
can_gen_swapL_imp_rev ns h g k seq d _UU0393_1 _UU0393_2 _UU0393_3 _UU0393_4 _UU0394_ =
  let {i = can_gen_swapL_def' ns} in
  case i of {
   (,) _ hH2 -> hH2 h g k seq d _UU0393_1 _UU0393_2 _UU0393_3 _UU0393_4 _UU0394_ __ __}
...
can_gen_swapR_imp_rev ns h g k seq d _UU0394_1 _UU0394_2 _UU0394_3 _UU0394_4 _UU0393_ =
  let {i = can_gen_swapR_def' ns} in
  case i of {
   (,) _ hH2 -> hH2 h g k seq d _UU0394_1 _UU0394_2 _UU0394_3 _UU0394_4 _UU0393_ __ __}
