...
Inductive principal_WBR {V : Set} {rules prems G} (D : derrec rules prems G)
...
Inductive principal_BBR {V : Set} {rules prems G} (D : derrec rules prems G)
          (A : PropF V) (Γ Δ1 Δ2 : list (PropF V)) :=
...
Inductive principal_WBL {V : Set} {rules prems G} (D : derrec rules prems G)
          (A : PropF V) (Γ1 Γ2 Δ : list (PropF V))  :=
| princ_WB1Ls Σ1 Σ2 Π : principal_WBox1Ls D A Γ1 Γ2 Δ Σ1 Σ2 Π ->
                           principal_WBL D A Γ1 Γ2 Δ
| princ_WB2Ls Σ1 Σ2 Π : principal_WBox2Ls D A Γ1 Γ2 Δ Σ1 Σ2 Π ->
                   principal_WBL D A Γ1 Γ2 Δ.

Inductive principal_BBL {V : Set} {rules prems G} (D : derrec rules prems G)
          (A : PropF V) (Γ1 Γ2 Δ : list (PropF V)) :=
| princ_BB1Ls Σ1 Σ2 Π : principal_BBox1Ls D A Γ1 Γ2 Δ Σ1 Σ2 Π ->
                           principal_BBL D A Γ1 Γ2 Δ
| princ_BB2Ls Σ1 Σ2 Π : principal_BBox2Ls D A Γ1 Γ2 Δ Σ1 Σ2 Π ->
                   principal_BBL D A Γ1 Γ2 Δ.

Inductive principal_not_box_R  {V : Set} {G} (D : pf_LNSKt G)
          (A : PropF V) (Γ Δ1 Δ2 : list (PropF V)) :=
...
Inductive right_principal {V : Set} {rules prems G} (D : derrec rules prems G) (A : PropF V) Δ1 Δ2 :=
  | r_princ_WBR Γ :
      principal_WBR D A Γ Δ1 Δ2 -> right_principal D A Δ1 Δ2
  | r_princ_BBR Γ :
      principal_BBR D A Γ Δ1 Δ2 -> right_principal D A Δ1 Δ2
  | r_princ_Id Γ1 Γ2 :
      principal_Id_pfc D A Γ1 Γ2 Δ1 Δ2 -> right_principal D A Δ1 Δ2
  | r_princ_ImpR Γ1 Γ2 :
      principal_ImpR D A Γ1 Γ2 Δ1 Δ2 -> right_principal D A Δ1 Δ2.

Inductive left_principal {V : Set} {rules prems G} (D : derrec rules prems G) (A : PropF V) Γ1 Γ2 :=
  | l_princ_WBL Δ :
      principal_WBL D A Γ1 Γ2 Δ -> left_principal D A Γ1 Γ2
  | l_princ_BBL Δ :
      principal_BBL D A Γ1 Γ2 Δ -> left_principal D A Γ1 Γ2
  | l_princ_Id Δ1 Δ2 :
      principal_Id_pfc D A Γ1 Γ2 Δ1 Δ2 -> left_principal D A Γ1 Γ2
  | l_princ_BotL Δ :
      principal_BotL_pfc D A Γ1 Γ2 Δ -> left_principal D A Γ1 Γ2
  | l_princ_ImpL Δ1 Δ2 :
      principal_ImpL D A Γ1 Γ2 Δ1 Δ2 -> left_principal D A Γ1 Γ2.

Inductive not_right_principal {V : Set} {rules prems G} (D : derrec rules prems G) (A : PropF V) (Δ1 Δ2 : list (PropF V)) :=
| nr_princ_right B Δ1' Δ2' :
    Δ1 <> Δ1' ->
    right_principal D B Δ1' Δ2' -> not_right_principal D A Δ1 Δ2
| nr_princ_left B Γ1 Γ2 :
    left_principal D B Γ1 Γ2 -> not_right_principal D A Δ1 Δ2
| nr_princ_EW :
    last_rule_EW D -> not_right_principal D A Δ1 Δ2.

Inductive not_left_principal {V : Set} {rules prems G} (D : derrec rules prems G) (A : PropF V) (Γ1 Γ2 : list (PropF V)) :=
| nl_princ_left B Γ1' Γ2' :
    Γ1 <> Γ1' ->
    left_principal D B Γ1' Γ2' -> not_left_principal D A Γ1 Γ2
| nl_princ_right B Δ1 Δ2 :
    right_principal D B Δ1 Δ2 -> not_left_principal D A Γ1 Γ2
| nl_princ_EW :
    last_rule_EW D -> not_left_principal D A Γ1 Γ2.