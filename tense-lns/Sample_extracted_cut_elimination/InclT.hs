...
inclT_consL_InT :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1
                   -> (Coq_inclT a1) -> GenT.InT a1
inclT_consL_InT l1 _ a hincl =
  hincl a (GenT.InT_eq' a l1)

inclT_consL_inclT :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) -> a1
                     -> (Coq_inclT a1) -> Coq_inclT a1
inclT_consL_inclT l1 _ a hincl b hin =
  hincl b (GenT.InT_cons a l1 hin)

inclT_appL :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
              (Datatypes.Coq_list a1) -> (Coq_inclT a1) -> (Coq_inclT 
              a1) -> Coq_inclT a1
...
inclT_appL_refl :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
                   Coq_inclT a1
inclT_appL_refl l1 l2 a ha =
  GenT.coq_InT_appL a l1 l2 ha

inclT_appRL :: (Datatypes.Coq_list a1) -> (Datatypes.Coq_list a1) ->
               (Datatypes.Coq_list a1) -> (Coq_inclT a1) -> Coq_inclT 
               a1
