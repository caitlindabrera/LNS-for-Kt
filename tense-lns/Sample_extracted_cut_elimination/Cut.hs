...
coq_LNSKt_cut_admissibility :: (LNS.LNS a1) -> (LNS.LNS a1) ->
                               ...
                               a1) -> DdT.Coq_pf (LNS.LNS a1)
                               (LNSKt_calculus.LNSKt_rules a1)
coq_LNSKt_cut_admissibility ns1 ns2 d1 d2 g1 g2 g3 s1 s2 d _UU0393_ _UU0394_1 _UU0394_2 _UU03a3_1 _UU03a3_2 _UU03a0_ a x h3 =
  let {
      ...
      Datatypes.Coq_pair p1 x1 ->
       (case p1 of {
         Datatypes.Coq_pair lS1 lS2 -> (\lS3 lS4 ->
          Logic.eq_rect_r
            (Datatypes.app g1 (Datatypes.Coq_cons (Datatypes.Coq_pair s1 d)
            ...
            Logic.eq_rect_r (Datatypes.Coq_pair _UU0393_
              ...
              Logic.eq_rect_r
                (Datatypes.app g2 (Datatypes.Coq_cons (Datatypes.Coq_pair s2
                  d) Datatypes.Coq_nil)) (\d5 lS13 lS14 lS15 lS16 ->
                Logic.eq_rect_r (Datatypes.Coq_pair
                  ...
                  Logic.eq_rect
                    ...
                    (Datatypes.app g3 (Datatypes.Coq_cons (Datatypes.Coq_pair
                      ...
                      (Datatypes.app _UU0394_1
                        (Datatypes.app _UU0394_2 _UU03a0_))) d)
                      Datatypes.Coq_nil))) s2 d5 lS16 lS15 lS14 lS13) ns2 d2
                lS12 lS11 lS10 lS9) s1 d3 lS8 lS7 lS6 lS5) ns1 d1 lS1 lS2 lS3
            lS4)}) x1}) x0}
...
data Cut_rule v =
 ...
 (Datatypes.Coq_list (LNS.PropF v))) LNS.Coq_dir)) (Datatypes.Coq_prod
                                                   ...
                                                   (LNS.PropF v))
                                                   (Datatypes.Coq_list
                                                   (LNS.PropF v))) (Datatypes.Coq_prod
                                                                   (Datatypes.Coq_list
                                                                   (LNS.PropF
                                                                   v))
                                                                   (Datatypes.Coq_list
                                                                   ...
                                                                   v))) 
 (Datatypes.Coq_prod (Datatypes.Coq_list (LNS.PropF v))
 (Datatypes.Coq_list (LNS.PropF v))) (Datatypes.Coq_list
                                     (Datatypes.Coq_prod
                                     (Datatypes.Coq_prod
                                     (Datatypes.Coq_list (LNS.PropF v))
                                     (Datatypes.Coq_list (LNS.PropF v)))
                                     LNS.Coq_dir)) (Datatypes.Coq_list
                                                   (Datatypes.Coq_prod
                                                   (Datatypes.Coq_prod
 ...
 (Datatypes.Coq_list (LNS.PropF v)) (LNS.PropF v) (Merge.Coq_merge v) 
 (Structural_equivalence.Coq_struct_equiv_str v)

data LNSKt_cut_rules v =
   LNSKt_rules_woc (Datatypes.Coq_list (LNS.LNS v)) (LNS.LNS v) (LNSKt_calculus.LNSKt_rules
                                                                v)
 | LNSKt_rules_wc (Datatypes.Coq_list (LNS.LNS v)) (LNS.LNS v) (Cut_rule v)

type Coq_pf_LNSKt_cut v = DdT.Coq_derrec (LNS.LNS v) (LNSKt_cut_rules v) ()

coq_LNSKt_cut_elimination :: (LNS.LNS a1) -> (Coq_pf_LNSKt_cut a1) ->
                             LNSKt_calculus.Coq_pf_LNSKt a1
coq_LNSKt_cut_elimination ns h =
  let {n = Dd_fc.derrec_height ns h} in
  Ind_lex.wf_lt_inductionT (\n0 x ->
    (case n0 of {
                ...
                Logic.eq_rect_r ps (\_ ->
                  Logic.eq_rect_r concl (\x2 -> DdT.Coq_derI ps concl x2
                    (DdT.dersrecI_forall ps (\p hin ->
                      let {x3 = Dd_fc.dersrecD_forall_in_dersrec ps d p hin}
                      in
                      case x3 of {
               ...
               LNSKt_rules_wc ps0 c x1 -> (\_ _ ->
                Logic.eq_rect_r ps (\_ ->
                  Logic.eq_rect_r concl (\x2 ->
                    (case x2 of {
                      Cut g1 g2 g3 s1 s2 s3 ns1 ns2 ns3 d0 _UU0393_ _UU0394_1
                       _UU0394_2 _UU03a3_1 _UU03a3_2 _UU03a0_ a x3 h5 ->
                       (\_ _ ->
                                    ...
                                    Datatypes.Coq_pair hin1 hin2 ->
                                     Logic.eq_rect_r (Datatypes.Coq_pair
                                       ...
                                       coq_LNSKt_cut_admissibility
                                                     ...
                                                     Logic.eq_rect_r
                                                       ...
                                                       (x11
                                                         ...
                                                         (Datatypes.app g1
                                                           ...
                                                           Datatypes.Coq_nil))
                                                         d7 __) ns3) s2 d8
                                                     x10 l5 __ d9 hin8 hin7)
                                                   ns2 d6 x9 l4 __ d3 hin6
                                                   hin5) s1 d4 x8 l3 __ d5
                                                 hin4 hin3) ns1 d1 x7 l2 __
                                               d2 hin1 hin2) n1 x0 __) h'1
                                           __)
                                         (Logic.eq_rect_r (DdT.Coq_derI
                                           (Datatypes.Coq_cons ns1
                                           (Datatypes.Coq_cons ns2
                                                   ...
                                                   Logic.eq_rect_r
                                                     ...
                                                     x11
                                                       ...
                                                       (Datatypes.app g2
                                                         ...
                                                         _UU03a0_) d0)
                                                         Datatypes.Coq_nil))
                                                       d9 __) s2 d7 x10 l5 __
                                                     d8 hin8 hin7) ns2 d6 x9
                                                   l4 __ d3 hin6 hin5) s1 d4
                                                 x8 l3 __ d5 hin4 hin3) ns1
                                               d1 x7 l2 __ d2 hin1 hin2) n1
                                             x0 __) h'1 __) g1 g2 g3
                                         (Datatypes.Coq_pair _UU0393_
                                         (Datatypes.app _UU0394_1
                                           (Datatypes.app (Datatypes.Coq_cons
                                         ...
                                         _UU03a0_ a x4 h6) s3 h'0 __ l1 __ __}}})
                               concl l0 h' __ __ x5 __) ps l d __ __ x2) ns3)
                         ps __ __ __ __ __ __ __ x3 h5)}) __ __) c) ps0 __ x1)})
              __ __) n1)}) h0 __ __)}) x) n ns h __
