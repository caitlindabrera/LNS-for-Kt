  ...
  Datatypes.Coq_pair (\x0 ->
    (case x0 of {
      ...
      ForallT_cons x1 l x2 x3 -> (\_ ->
       Logic.eq_rect_r x (\_ ->
         Logic.eq_rect_r Datatypes.Coq_nil (\x4 _ -> x4) l) x1 __ x2 x3)}) __)
    (\x0 -> ForallT_cons x Datatypes.Coq_nil x0 ForallT_nil)
         ...
         Logic.eq_rect_r (Datatypes.Coq_cons y Datatypes.Coq_nil) (\x4 x5 ->
           (case x5 of {
             ...
             ForallT_cons x6 l0 x7 x8 -> (\_ ->
              Logic.eq_rect_r y (\_ ->
                Logic.eq_rect_r Datatypes.Coq_nil (\x9 _ ->
                  Datatypes.Coq_pair x4 x9) l0) x6 __ x7 x8)}) __) l) x1 __
         x2 x3)}) __) (\x0 ->
    case x0 of {
     Datatypes.Coq_pair p p0 -> ForallT_cons x (Datatypes.Coq_cons y
      Datatypes.Coq_nil) p (ForallT_cons y Datatypes.Coq_nil p0 ForallT_nil)})

coq_ForallT_map_2 :: (a1 -> a2) -> a1 -> a1 -> CRelationClasses.Coq_iffT
                     (ForallT a2 a3) (Datatypes.Coq_prod a3 a3)
coq_ForallT_map_2 f x y =
  coq_ForallT_2 (f x) (f y)

coq_ForallT_map_rev :: (a1 -> a2) -> a1 -> CRelationClasses.Coq_iffT 
                       a3 (ForallT a2 a3)
coq_ForallT_map_rev f x =
  Datatypes.Coq_pair (\hH ->
    let {x0 = f x} in
    (case coq_ForallT_single x0 of {
...
coq_InT_rect :: a1 -> (a1 -> (Datatypes.Coq_list a1) -> () -> a2) -> (a1 ->
                (Datatypes.Coq_list a1) -> (InT a1) -> a2 -> a2) ->
                (Datatypes.Coq_list a1) -> (InT a1) -> a2
coq_InT_rect _ f f0 =
  let {
   f1 _ i =
     case i of {
...
coq_InT_appL :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                a1) -> (InT a1) -> InT a1
...
coq_InT_appR :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                a1) -> (InT a1) -> InT a1
coq_InT_appR _ x y x0 =
  Datatypes.list_rect x0 (\a0 x1 iHX -> InT_cons a0 (Datatypes.app x1 y) iHX)
    x

coq_InT_appE' :: a1 -> (Datatypes.Coq_list a1) -> (InT a1) ->
...
coq_InT_appE' a z x x0 y =
  coq_InT_rect a (\b l _ x1 y0 _ ->
    (case x1 of {
      Datatypes.Coq_nil -> (\_ ->
       Logic.eq_rect_r a (\_ ->
         Logic.eq_rect (Datatypes.Coq_cons a l) (Datatypes.Coq_inr
           (coq_InT_eq a l)) y0) b __);
      Datatypes.Coq_cons a0 x2 -> (\_ ->
       Logic.eq_rect_r a (\_ _ ->
         Logic.eq_rect_r (Datatypes.app x2 y0) (\_ ->
           Logic.eq_rect_r a0 (\_ -> Datatypes.Coq_inl (coq_InT_eq a0 x2)) a
             __) l __) b __ __)}) __) (\b l x1 iHX x2 y0 _ ->
    (case x2 of {
      Datatypes.Coq_nil -> (\_ ->
       Logic.eq_rect (Datatypes.Coq_cons b l) (Datatypes.Coq_inr (InT_cons b
         l x1)) y0);
       ...
       Logic.eq_rect_r (Datatypes.app x3 y0) (\_ iHX0 _ ->
         Logic.eq_rect_r a0 (\_ ->
           ...
           case e of {
            ...
            Datatypes.Coq_inr i -> Datatypes.Coq_inr i}) b __) l x1 iHX __)})
      __) z x x0 y __

coq_InT_appE :: a1 -> (Datatypes.Coq_list a1) -> (Datatypes.Coq_list 
                a1) -> (InT a1) -> Datatypes.Coq_sum (InT a1) (InT a1)
...
coq_InT_split x l x0 =
  coq_InT_rect x (\_ l0 _ -> Specif.Coq_existT Datatypes.Coq_nil
    (Specif.Coq_existT l0 __)) (\b l0 x1 iHX ->
    case iHX of {
     Specif.Coq_existT x2 s ->
      case s of {
       Specif.Coq_existT x3 _ ->
        Logic.eq_rect_r (Datatypes.app x2 (Datatypes.Coq_cons x x3)) (\_ ->
          Specif.Coq_existT (Datatypes.Coq_cons b x2) (Specif.Coq_existT x3
          __)) l0 x1}}) l x0

coq_InT_map :: (a1 -> a2) -> (Datatypes.Coq_list a1) -> a1 -> (InT a1) -> InT
               a2
...
coq_InT_mapE :: (a1 -> a2) -> (Datatypes.Coq_list a1) -> a2 -> (InT a2) ->
      ...
      InT_eq' b l1 -> (\_ ->
       Logic.eq_rect_r (f a) (\_ ->
         Logic.eq_rect_r (List.map f l0) (\_ ->
           Logic.eq_rect (f a) (\_ _ -> Specif.Coq_existT a
             (Datatypes.Coq_pair __ (coq_InT_eq a l0))) y x0 iHl) l1) b __ __);
      InT_cons b l1 x1 -> (\_ ->
       Logic.eq_rect_r (f a) (\_ ->
            ...
            Specif.Coq_existT x4 x5 ->
             case x5 of {
              Datatypes.Coq_pair _ x6 -> Specif.Coq_existT x4
               (Logic.eq_rect (f x4) (\_ _ -> Datatypes.Coq_pair __ (InT_cons
                 a l0 x6)) y x0 iHl)}}) l1) b __ x1)}) __) l x
     ...
     Specif.Coq_existT x0 x1 ->
      case x1 of {
       Datatypes.Coq_pair _ x2 ->
        Logic.eq_rect (f x0) (coq_InT_map f l x0 x2) y}})

coq_ForallT_forall :: (Datatypes.Coq_list a1) -> CRelationClasses.Coq_iffT
                      (ForallT a1 a2) (a1 -> (InT a1) -> a2)
coq_ForallT_forall l =
  Datatypes.list_rect (Datatypes.Coq_pair (\_ -> coq_InT_nilE) (\_ ->
    ForallT_nil)) (\a l0 iHl -> Datatypes.Coq_pair (\x x0 x1 ->
    case iHl of {
               ...
               InT_eq' b l2 -> (\_ ->
                Logic.eq_rect_r a (\_ ->
                  Logic.eq_rect_r l0 (\_ ->
                    Logic.eq_rect_r x0 (\_ _ x7 _ -> x7) a x x1 x5 __) l2) b
                  __ __);
               InT_cons b l2 x7 -> (\_ ->
                Logic.eq_rect_r a (\_ ->
                  Logic.eq_rect_r l0 (\x8 -> p x6 x0 x8) l2) b __ x7)}) __)
             l1) x2 __ x3 x4)}) __}) (\x ->
    case iHl of {
     Datatypes.Coq_pair _ f -> ForallT_cons a l0 (x a (coq_InT_eq a l0))
      (f (\x0 x1 -> x x0 (InT_cons a l0 x1)))})) l

coq_ForallTD_forall :: (Datatypes.Coq_list a1) -> (ForallT a1 a2) -> a1 ->
                       (InT a1) -> a2
coq_ForallTD_forall x =
  iffT_D1 (coq_ForallT_forall x)

coq_ForallTI_forall :: (Datatypes.Coq_list a1) -> (a1 -> (InT a1) -> a2) ->
                       ForallT a1 a2
coq_ForallTI_forall x =
  iffT_D2 (coq_ForallT_forall x)

want_prod_under_universal4 :: (a1 -> a2 -> Datatypes.Coq_prod
                              (Datatypes.Coq_prod (Datatypes.Coq_prod a3 a4)
                              a5) a6) -> Datatypes.Coq_prod
                              (Datatypes.Coq_prod
                              (Datatypes.Coq_prod (a1 -> a2 -> a3)
                              (a1 -> a2 -> a4)) (a1 -> a2 -> a5))
                              (a1 -> a2 -> a6)
...
prod_nat_split :: ((Datatypes.Coq_prod Datatypes.Coq_nat Datatypes.Coq_nat)
                  -> a1) -> Datatypes.Coq_nat -> Datatypes.Coq_nat -> a1
